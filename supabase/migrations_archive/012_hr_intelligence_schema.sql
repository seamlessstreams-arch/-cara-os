...
create table if not exists hr_sickness_episodes (
  ...
  stress_risk_assessment_done     boolean,
...
create table if not exists hr_exit_interviews (
  ...
  culture_concerns_raised         boolean,
  management_concerns_raised      boolean,
  workload_concerns_raised        boolean,
  pay_concerns_raised             boolean,
  rota_concerns_raised            boolean,
