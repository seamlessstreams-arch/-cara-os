// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/sanctions-rewards — Sanctions & Rewards Intelligence
//
...
import { analyseSanctionsRewards } from "@/lib/aria/sanctions-rewards-intelligence";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { SanctionsRewardsInput, SanctionRecord, RewardRecord } from "@/lib/aria/sanctions-rewards-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/sanctions-rewards] Error:", err);
    return NextResponse.json(
