...
import type { InfectionPreventionRating, InfectionPreventionResult } from "@/lib/engines/home-infection-prevention-control-intelligence-engine";
...
export function HomeInfectionPreventionControlIntelligenceCard() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: InfectionPreventionResult }>;
    },
