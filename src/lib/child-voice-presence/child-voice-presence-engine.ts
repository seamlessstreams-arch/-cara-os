// ══════════════════════════════════════════════════════════════════════════════
// CARA — CHILD VOICE PRESENCE INTELLIGENCE (pure engine)
//
...
//
// A PURE, deterministic projection over the in-memory store — the store is
// passed IN, no NextResponse, no LLM calls. The route is a thin wrapper.
// ══════════════════════════════════════════════════════════════════════════════
...
export interface ChildVoicePresenceData {
