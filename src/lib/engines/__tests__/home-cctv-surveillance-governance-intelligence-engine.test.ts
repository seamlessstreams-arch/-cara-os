...
describe("Home CCTV & Surveillance Governance Intelligence Engine", () => {
  ...
  describe("composite rates", () => {
    describe("policyComplianceRate", () => {
      ...
      it("returns null when no policy records", () => {
        const result = computeCctvSurveillanceGovernance(
    ...
    describe("privacyImpactRate", () => {
      ...
      it("returns null when no privacy impact records", () => {
        const result = computeCctvSurveillanceGovernance(
    ...
    describe("retentionComplianceRate", () => {
      ...
      it("returns null when no retention records", () => {
        const result = computeCctvSurveillanceGovernance(
          baseInput({ total_children: 0, cctv_policy_records: [makePolicy()] }),
        );
        expect(result.retention_compliance_rate).toBeNull();
    ...
    describe("childAwarenessRate", () => {
      ...
      it("returns null when no child awareness records", () => {
        const result = computeCctvSurveillanceGovernance(
          baseInput({ total_children: 0, cctv_policy_records: [makePolicy()] }),
        );
        expect(result.child_awareness_rate).toBeNull();
    ...
    describe("dataProtectionRate", () => {
      ...
      it("returns null when no data protection records", () => {
        const result = computeCctvSurveillanceGovernance(
          baseInput({ total_children: 0, cctv_policy_records: [makePolicy()] }),
        );
        expect(result.data_protection_rate).toBeNull();
