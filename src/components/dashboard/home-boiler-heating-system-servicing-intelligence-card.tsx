...
import type { BoilerHeatingRating, BoilerHeatingSystemServicingResult } from "@/lib/engines/home-boiler-heating-system-servicing-intelligence-engine";
...
function useHomeBoilerHeatingSystemServicingIntelligence() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: BoilerHeatingSystemServicingResult }>;
    },
