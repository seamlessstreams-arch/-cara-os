...
export function generateDemoData(): {
  ...
  const orders: CourtOrder[] = [
    ...
    },
    {
      ...
      dateGranted: seedDay(-118),
      expiryDate: seedDay(63),
      isActive: true,
      conditions: [
        {
          conditionType: "contact_frequency",
    ...
    },
    {
      ...
      conditions: [
        ...
        },
        {
          ...
          complianceStatus: "fully_compliant",
          lastEvidenced: seedDay(-13),
        },
      ],
      lastReviewDate: seedDay(-69),
      nextReviewDue: seedDay(115),
      socialWorkerAssigned: true,
      localAuthority: "Anytown Council",
    },
  ];
