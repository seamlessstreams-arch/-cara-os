// ══════════════════════════════════════════════════════════════════════════════
// Tests: AriaContextLinker _testing exports
// ══════════════════════════════════════════════════════════════════════════════

import { describe, it, expect } from "vitest";
import { _testing } from "@/components/aria/aria-context-linker";

const { TABLE_CONFIG, RELATIONSHIP_LABELS, STATUS_CONFIG, getDemoLinks } = _testing;

describe("AriaContextLinker", () => {
  ...
  describe("getDemoLinks", () => {
    ...
    it("each link has required fields", () => {
      ...
      for (const link of links) {
        ...
        expect(link.createdBy).toMatch(/^(aria|user)$/);
      }
    });
