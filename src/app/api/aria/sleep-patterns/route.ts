// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/sleep-patterns — Sleep Pattern Intelligence
//
...
import { analyseSleepPatterns } from "@/lib/aria/sleep-pattern-intelligence";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { SleepInput, SleepNight } from "@/lib/aria/sleep-pattern-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/sleep-patterns] Error:", err);
    return NextResponse.json(
