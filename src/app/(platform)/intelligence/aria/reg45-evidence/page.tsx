...
// ══════════════════════════════════════════════════════════════════════════════
// CORNERSTONE — ARIA REG 45 LIVE EVIDENCE BANK
// Themed evidence chips drafted from verified records and approved ARIA
...
export default function Reg45EvidencePage() {
  ...
  return (
    <PageShell
      ...
      subtitle="Continuously updated themed evidence drawn from verified records and approved ARIA outputs. ARIA suggests — managers decide what enters the official Reg 45 report."
      actions={
