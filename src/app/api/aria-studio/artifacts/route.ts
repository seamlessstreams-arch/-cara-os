// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/artifacts — List and create artifacts
// ══════════════════════════════════════════════════════════════════════════════
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/artifacts] GET error:", err);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/artifacts] POST error:", err);
