...
import {
  ...
  // Compliance icons
  Gavel, Gauge, Scale, Eye, Flag, ClipboardCheck, Award,
  // Reports icons
  BarChart2,
  // Cara icons
  ...
  Wand2,
  // Other
  Ear, EarOff, BellOff, ScanEye, Sprout, DoorOpen, Target, ArrowRightLeft, CheckSquare, User, Moon, Share2, FolderArchive, GitCompare, LineChart,
  // Domain nav icons
