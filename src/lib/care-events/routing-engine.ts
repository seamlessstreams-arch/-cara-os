...
const ROUTES_BY_CATEGORY: Record<CareEventCategory, RouteType[]> = {
  ...
  safeguarding:           ["daily_log", "child_daily_summary", "safeguarding_record", "incident", "management_oversight", "reg40_triage", "reg45_evidence", "annex_a_evidence", "filing_cabinet", "saved_time"],
  missing_episode:        ["daily_log", "child_daily_summary", "missing_episode", "incident", "management_oversight", "reg40_triage", "reg45_evidence", "annex_a_evidence", "filing_cabinet", "saved_time"],
  physical_intervention:  ["daily_log", "child_daily_summary", "physical_intervention", "incident", "management_oversight", "reg40_triage", "reg45_evidence", "annex_a_evidence", "filing_cabinet", "saved_time"],
  restraint:              ["daily_log", "child_daily_summary", "physical_intervention", "incident", "management_oversight", "reg40_triage", "reg45_evidence", "annex_a_evidence", "filing_cabinet", "saved_time"],
  complaint:              ["daily_log", "child_daily_summary", "complaint_record", "management_oversight", "reg45_evidence", "annex_a_evidence", "filing_cabinet", "saved_time"],
