// ══════════════════════════════════════════════════════════════════════════════
// CARA — PRACTICE CULTURE SCORECARD — pure engine
//
...
export interface PracticeCultureDimension {
  id: string;
  label: string;
  description: string;
  score: number;
...
export interface PracticeCultureSummary {
...
export interface PracticeCultureData {
  overallScore: number;
  overallStatus: RAGStatus;
  dimensions: PracticeCultureDimension[];
  summary: PracticeCultureSummary;
}
