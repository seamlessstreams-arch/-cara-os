...
import { generateRoleVersion, generateAllRoleVersions, getAvailableRoles } from "@/lib/aria-studio/role-output.service";
import type { OutputRole } from "@/lib/aria-studio/role-output.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[api/aria-studio/role-output] Error:", err);
