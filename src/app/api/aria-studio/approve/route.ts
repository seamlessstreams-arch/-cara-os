// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/approve — Approve or Reject Generated Content
//
...
import { approvalRequestSchema } from "@/lib/aria-studio/schemas";
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/approve] Error:", err);
    return NextResponse.json(
