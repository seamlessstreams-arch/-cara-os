...
import type { SiblingContactRating, SiblingContactResult } from "@/lib/engines/home-sibling-contact-protocol-intelligence-engine";
...
export function HomeSiblingContactProtocolIntelligenceCard() {
  const { data, isLoading } = useQuery<{ data: SiblingContactResult }>({
