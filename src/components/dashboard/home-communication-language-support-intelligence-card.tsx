...
import type { CommunicationSupportRating, CommunicationLanguageSupportResult } from "@/lib/engines/home-communication-language-support-intelligence-engine";
...
function useHomeCommunicationLanguageSupportIntelligence() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: CommunicationLanguageSupportResult }>;
    },
