...
function emptyResult(
  ...
  return {
    ...
    meal_plan_compliance_rate: null,
    dietary_requirement_coverage_rate: null,
    nutrition_assessment_rate: null,
    food_hygiene_score: 0,
    special_diet_adherence_rate: null,
    child_choice_rate: null,
    meal_nutritional_guideline_rate: null,
    allergen_check_rate: null,
    fresh_ingredient_rate: null,
    cultural_needs_met_rate: null,
    staff_food_hygiene_training_rate: null,
    corrective_action_completion_rate: null,
    dietary_documentation_rate: null,
    dietary_staff_informed_rate: null,
    emergency_plan_rate: null,
    nutrition_goals_met_rate: null,
    dietitian_referral_completion_rate: null,
    strengths: [],
    concerns: [],
    recommendations: [],
    insights: [],
