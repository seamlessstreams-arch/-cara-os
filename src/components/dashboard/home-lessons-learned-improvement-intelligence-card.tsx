...
import type { LessonsLearnedRating, LessonsLearnedResult } from "@/lib/engines/home-lessons-learned-improvement-intelligence-engine";
...
export function HomeLessonsLearnedImprovementIntelligenceCard() {
  const { data: queryData, isLoading } = useQuery<{ data: LessonsLearnedResult }>({
