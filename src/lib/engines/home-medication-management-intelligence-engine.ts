...
export function computeHomeMedicationManagement(
  ...
  if (total_children === 0 || medications.length === 0) {
    return {
      ...
      administration: { total_scheduled: 0, total_given: 0, total_late: 0, total_refused: 0, total_missed: 0, total_withheld: 0, compliance_rate: null, on_time_rate: null, refusal_rate: null },
      witnessing: { total_administered: 0, witnessed_count: 0, witnessing_rate: null },
      stock: { active_medications: 0, with_stock_data: 0, low_stock_count: 0, stock_check_rate: null, overdue_stock_checks: 0 },
      errors: { total_errors_90d: 0, by_severity: {}, open_errors: 0, error_rate: null },
