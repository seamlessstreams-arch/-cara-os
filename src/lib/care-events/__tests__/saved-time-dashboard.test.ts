...
import { loadSavedTimeDashboardFromStore } from "@/lib/care-events/saved-time-dashboard";
...
describe("loadSavedTimeDashboardFromStore", () => {
  it("returns zeros for an empty home", () => {
    const d = loadSavedTimeDashboardFromStore(HOME_ID);
