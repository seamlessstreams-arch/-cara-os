...
import type { BathroomAccessibilityRating, BathroomAccessibilityAdaptationsResult } from "@/lib/engines/home-bathroom-accessibility-adaptations-intelligence-engine";

function useHomeBathroomAccessibilityAdaptationsIntelligence() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: BathroomAccessibilityAdaptationsResult }>;
    },
