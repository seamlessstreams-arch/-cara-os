...
export async function GET() {
  ...
  const domains: DomainDigest[] = [
    ...
    },
    {
      ...
      compliance_rate: Math.round(placement.home_metrics.average_stability_score ?? 0),
      overdue_count: 0,
      ...
      key_metric_value: Math.round(placement.home_metrics.average_stability_score ?? 0),
