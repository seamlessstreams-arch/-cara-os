// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/quality-check — Run quality checks on an artifact
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { runQualityCheck } from "@/lib/aria-studio/quality-check.service";
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/quality-check] Error:", err);
