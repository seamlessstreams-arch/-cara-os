...
import type { BathroomShowerRating, BathroomShowerFacilitiesResult } from "@/lib/engines/home-bathroom-shower-facilities-intelligence-engine";
...
function useHomeBathroomShowerFacilitiesIntelligence() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: BathroomShowerFacilitiesResult }>;
    },
