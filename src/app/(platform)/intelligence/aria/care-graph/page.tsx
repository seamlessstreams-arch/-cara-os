...
// ARIA drafts the structure. Humans approve every connection.
// ══════════════════════════════════════════════════════════════════════════════
...
export default function CareGraphPage() {
  ...
  return (
    <PageShell
      title="ARIA Care Graph"
      subtitle="Linked view of every child, incident, risk, plan, pattern and warning. ARIA drafts the connections — managers approve before they influence statutory records."
      actions={
