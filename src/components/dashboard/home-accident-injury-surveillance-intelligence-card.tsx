...
import type { AccidentInjuryRating, AccidentInjuryResult } from "@/lib/engines/home-accident-injury-surveillance-intelligence-engine";
...
export function HomeAccidentInjurySurveillanceIntelligenceCard() {
  const { data, isLoading } = useQuery<AccidentInjuryResponse>({
