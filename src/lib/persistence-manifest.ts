...
export const PERSISTENCE_MANIFEST: PersistenceEntry[] = [
  ...
  { entity: "Reg 44 independent visitor reports (sections A–Q)", area: "Intelligence layer", write_through: true, table: "reg44_reports / reg44_report_audit", audit_trail: "Append-only reg44_report_audit: created, edited, validated, signed, addendum, edit_refused — with actor and time", note: "Signed reports are locked; the signed snapshot and rendered sections are frozen on the row and later changes go in as addenda" },
  { entity: "Reg 44 visit tracker & actions", area: "Intelligence layer", write_through: true, table: "reg44_reports (projection) / reg44_actions", audit_trail: "Responses audited on reg44_report_audit ('responded'); actions carry created_by + timestamps; intelligence audit", note: "A visit IS its A–Q report since the tracker fold; reg44_visits retired (20260918160000)" },
