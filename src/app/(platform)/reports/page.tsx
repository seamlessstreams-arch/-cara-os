...
import type { Incident, LeaveRequest, TrainingRecord, Task, YoungPerson, StaffMember } from "@/types";
    ...
    <PageShell
      ...
      actions={
        <div className="flex items-center gap-2">
          <PrintButton title="Reports" subtitle="Management Reports" targetId="reports-content" />
