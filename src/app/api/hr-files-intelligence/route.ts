...
const DEMO_RECORDS: HrFilesRecord[] = [
  ...
  { id: "hr-010", homeId: "home-oak", date: "2026-02-05", childId: "staff-darren", childName: "Olivia Hayes", category: "training_completion", outcome: "fully_compliant", recordAccurate: true, signaturesObtained: true, actionPointsDocumented: true, timeframesMet: true, documentationComplete: true, timelyRecording: true },
  { id: "hr-011", homeId: "home-oak", date: "2026-03-20", childId: "staff-darren", childName: "Olivia Hayes", category: "dbs_check", outcome: "fully_compliant", recordAccurate: true, signaturesObtained: true, actionPointsDocumented: true, timeframesMet: true, documentationComplete: true, timelyRecording: true },
  { id: "hr-012", homeId: "home-oak", date: "2026-05-01", childId: "staff-darren", childName: "Olivia Hayes", category: "absence_management", outcome: "fully_compliant", recordAccurate: true, signaturesObtained: true, actionPointsDocumented: false, timeframesMet: true, documentationComplete: false, timelyRecording: true },
];
