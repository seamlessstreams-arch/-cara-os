...
function emptyResult(
  ...
  return {
    ...
    contact_compliance_rate: null,
    family_visit_quality_rate: null,
    parental_engagement_rate: null,
    ...
    supervised_boundary_adherence_rate: null,
    family_support_attendance_rate: null,
    strengths: [],
    concerns: [],
    recommendations: [],
    insights: [],
