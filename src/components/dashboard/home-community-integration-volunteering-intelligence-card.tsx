...
import type { CommunityIntegrationRating, CommunityIntegrationResult } from "@/lib/engines/home-community-integration-volunteering-intelligence-engine";
...
function useHomeCommunityIntegrationVolunteeringIntelligence() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: CommunityIntegrationResult }>;
    },
