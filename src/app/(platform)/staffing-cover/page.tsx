...
import type { CoverSeverity, CoverStatus, PeriodCover, StaffingCoverResult, StaffingPolicy } from "@/lib/rota/staffing-cover-engine";

interface StaffingCoverData extends StaffingCoverResult {
  policy: StaffingPolicy;
  projected_count: number;
}

function useStaffingCover(from?: string, to?: string) {
 ...
 */
function useLogCoverReason(from?: string, to?: string) {
 ...
 */
function useUpdateStaffingPolicy(from?: string, to?: string) {
  const qc = useQueryClient();
  return useMutation({
