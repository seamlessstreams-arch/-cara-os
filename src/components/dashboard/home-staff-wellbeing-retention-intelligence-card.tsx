...
import type { StaffWellbeingRating, StaffWellbeingRetentionResult } from "@/lib/engines/home-staff-wellbeing-retention-intelligence-engine";
...
function useHomeStaffWellbeingRetentionIntelligence() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: StaffWellbeingRetentionResult }>;
    },
