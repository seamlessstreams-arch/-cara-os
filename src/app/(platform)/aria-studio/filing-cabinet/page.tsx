          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-[var(--cs-text-secondary)] mt-0.5">
                Committed ARIA Studio artifacts automatically filed into Ofsted-aligned folder structures.
              </p>
            </div>
          </div>
        </div>
                ...
                {selectedPath ? (
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-[var(--cs-text-muted)]">
                      Artifacts filed in this location will appear here once committed through the ARIA Studio approval workflow.
                    </p>
