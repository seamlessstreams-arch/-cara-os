...
export interface CommunicationLanguageSupportResult {
  ...
  assessment_coverage_rate: number | null;
  /** null when the population is empty — nothing measured, not 0%. */
  therapy_engagement_rate: number | null;
  /** null when the population is empty — nothing measured, not 0%. */
  aid_provision_rate: number | null;
  /** null when the population is empty — nothing measured, not 0%. */
  inclusive_practice_rate: number | null;
  /** null when the population is empty — nothing measured, not 0%. */
...
function emptyResult(
  ...
  return {
    ...
    assessment_coverage_rate: null,
    therapy_engagement_rate: null,
    aid_provision_rate: null,
    inclusive_practice_rate: null,
...
export function computeCommunicationLanguageSupport(
  ...
  const assessmentComprehensivenessRate = rate(totalAssessmentChecksPassed, totalAssessmentChecksPossible);
  ...
  const therapyAttendanceRate = rate(sessionsAttended, totalTherapySessions);

  const childEngagedInTherapy = speech_therapy_records.filter(
    (r) => r.child_engaged,
  ).length;
  const therapyEngagementRate = rate(childEngagedInTherapy, totalTherapySessions);

  const targetsMet = speech_therapy_records.filter((r) => r.targets_met).length;
  const targetsMetRate = rate(targetsMet, totalTherapySessions);
  ...
  const homePracticeCompletionRate = rate(homePracticeCompleted, homePracticeAssigned);

  const staffGuidanceProvided = speech_therapy_records.filter(
    (r) => r.staff_guidance_provided,
  ).length;
  const staffGuidanceRate = rate(staffGuidanceProvided, totalTherapySessions);
  ...
  const aidChildFeedbackRate = rate(childFeedbackPositiveOnAids, totalAids);
  ...
  const replacementActionRate = rate(replacementsActioned, replacementsNeeded);
  ...
  const aidProvisionRate = rate(aidProvisionNumerator, aidProvisionDenominator);
  ...
  const feedbackPositiveRate = rate(feedbackPositive, totalInclusivePractice);
  ...
  const inclusivePracticeRate = rate(inclusivePracticeNumerator, inclusivePracticeDenominator);
  ...
  const practiceApplicationRate = rate(appliedInPractice, totalTrainingRecords);
  ...
  const refresherCompletionRate = rate(refreshersCompleted, refreshersDue);
  ...
  const staffTrainingRate = rate(staffTrainingNumerator, staffTrainingDenominator);
  ...
  if (meets(assessmentCoverageRate, 90)) score += 4;
  else if (meets(assessmentCoverageRate, 70)) score += 2;

  // --- Bonus 2: therapyEngagementRate (>=90: +4, >=70: +2) ---
  if (meets(therapyEngagementRate, 90)) score += 4;
  else if (meets(therapyEngagementRate, 70)) score += 2;

  // --- Bonus 3: aidProvisionRate (>=85: +3, >=65: +1) ---
  if (meets(aidProvisionRate, 85)) score += 3;
  else if (meets(aidProvisionRate, 65)) score += 1;

  // --- Bonus 4: inclusivePracticeRate (>=85: +3, >=65: +1) ---
  if (meets(inclusivePracticeRate, 85)) score += 3;
  else if (meets(inclusivePracticeRate, 65)) score += 1;

  // --- Bonus 5: staffTrainingRate (>=85: +3, >=65: +1) ---
  if (meets(staffTrainingRate, 85)) score += 3;
  else if (meets(staffTrainingRate, 65)) score += 1;
  ...
  if (meets(homePracticeCompletionRate, 90)) score += 3;
  else if (meets(homePracticeCompletionRate, 70)) score += 1;
  ...
  if (meets(supportPlanReviewRate, 90)) score += 3;
  else if (meets(supportPlanReviewRate, 70)) score += 1;

  // ── Penalties ─────────────────────────────────────────────────────────

  // assessmentCoverageRate < 40 → -6 (guarded by records > 0)
  if (below(assessmentCoverageRate, 40) && totalAssessments > 0) score -= 6;

  // therapyEngagementRate < 50 → -5 (guarded by records > 0)
  if (below(therapyEngagementRate, 50) && totalTherapySessions > 0) score -= 5;

  // inclusivePracticeRate < 40 → -5 (guarded by records > 0)
  if (below(inclusivePracticeRate, 40) && totalInclusivePractice > 0) score -= 5;

  // staffTrainingRate < 40 → -3 (guarded by records > 0)
  if (below(staffTrainingRate, 40) && totalTrainingRecords > 0) score -= 3;
  ...
  if (meets(assessmentCoverageRate, 90) && totalAssessments > 0) {
    strengths.push(
  ...
  } else if (meets(assessmentCoverageRate, 70) && totalAssessments > 0) {
    strengths.push(
  ...
  if (meets(therapyEngagementRate, 90) && totalTherapySessions > 0) {
    strengths.push(
  ...
  } else if (meets(aidProvisionRate, 65) && totalAids > 0) {
    strengths.push(
  ...
  if (meets(inclusivePracticeRate, 85) && totalInclusivePractice > 0) {
    strengths.push(
  ...
  } else if (meets(inclusivePracticeRate, 65) && totalInclusivePractice > 0) {
    strengths.push(
  ...
  if (meets(staffTrainingRate, 85) && totalTrainingRecords > 0) {
    strengths.push(
  ...
  } else if (meets(staffTrainingRate, 65) && totalTrainingRecords > 0) {
    strengths.push(
  ...
  if (meets(childInvolvementRate, 90) && totalAssessments > 0) {
    strengths.push(
  ...
  } else if (meets(therapyAttendanceRate, 70) && totalTherapySessions > 0) {
    strengths.push(
      `${therapyAttendanceRate}% therapy attendance — the majority of scheduled speech therapy sessions are attended.`,
    );
  }

  if (meets(homePracticeCompletionRate, 90) && homePracticeAssigned > 0) {
    strengths.push(
  ...
  } else if (meets(homePracticeCompletionRate, 70) && homePracticeAssigned > 0) {
    strengths.push(
  ...
  if (meets(childViewsRate, 90) && totalAssessments > 0) {
    strengths.push(
  ...
  } else if (meets(supportPlanReviewRate, 70) && totalAssessments > 0) {
    strengths.push(
  ...
  if (meets(staffGuidanceRate, 90) && totalTherapySessions > 0) {
    strengths.push(
  ...
  if (meets(outcomesSharedRate, 90) && totalAssessments > 0) {
    strengths.push(
  ...
  if (meets(assessmentComprehensivenessRate, 90) && totalAssessments > 0) {
    strengths.push(
  ...
  if (meets(targetsMetRate, 80) && totalTherapySessions > 0) {
    strengths.push(
  ...
  if (below(assessmentCoverageRate, 40) && totalAssessments > 0) {
    concerns.push(
  ...
  } else if (meets(assessmentCoverageRate, 40) && below(assessmentCoverageRate, 70) && totalAssessments > 0) {
    concerns.push(
  ...
  if (below(therapyEngagementRate, 50) && totalTherapySessions > 0) {
    concerns.push(
  ...
  } else if (meets(therapyEngagementRate, 50) && below(therapyEngagementRate, 70) && totalTherapySessions > 0) {
    concerns.push(
  ...
  if (below(aidProvisionRate, 40) && totalAids > 0) {
    concerns.push(
  ...
  } else if (meets(aidProvisionRate, 40) && below(aidProvisionRate, 65) && totalAids > 0) {
    concerns.push(
  ...
  if (below(inclusivePracticeRate, 40) && totalInclusivePractice > 0) {
    concerns.push(
  ...
  } else if (meets(inclusivePracticeRate, 40) && below(inclusivePracticeRate, 65) && totalInclusivePractice > 0) {
    concerns.push(
  ...
  } else if (meets(staffTrainingRate, 40) && below(staffTrainingRate, 65) && totalTrainingRecords > 0) {
    concerns.push(
  ...
  if (below(childInvolvementRate, 50) && totalAssessments > 0) {
    concerns.push(
  ...
  if (below(therapyAttendanceRate, 50) && totalTherapySessions > 0) {
    concerns.push(
  ...
  } else if (meets(therapyAttendanceRate, 50) && below(therapyAttendanceRate, 70) && totalTherapySessions > 0) {
    concerns.push(
  ...
  if (below(homePracticeCompletionRate, 50) && homePracticeAssigned > 0) {
    concerns.push(
  ...
  } else if (meets(homePracticeCompletionRate, 50) && below(homePracticeCompletionRate, 70) && homePracticeAssigned > 0) {
    concerns.push(
      `Home practice completion at ${homePracticeCompletionRate}% — some therapy exercises are not being completed between sessions.`,
    );
  }

  if (below(supportPlanRate, 50) && totalAssessments > 0) {
    concerns.push(
  ...
  if (below(childViewsRate, 50) && totalAssessments > 0) {
    concerns.push(
  ...
  if (below(needsDocumentationRate, 50) && totalAssessments > 0) {
    concerns.push(
  ...
  if (below(replacementActionRate, 50) && replacementsNeeded > 0) {
    concerns.push(
  ...
  if (meets(assessmentCoverageRate, 40) && below(assessmentCoverageRate, 70) && totalAssessments > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (meets(therapyEngagementRate, 50) && below(therapyEngagementRate, 70) && totalTherapySessions > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (meets(inclusivePracticeRate, 40) && below(inclusivePracticeRate, 65) && totalInclusivePractice > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (meets(staffTrainingRate, 40) && below(staffTrainingRate, 65) && totalTrainingRecords > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (below(supportPlanReviewRate, 70) && totalAssessments > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (below(outcomesSharedRate, 70) && totalAssessments > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (below(childViewsRate, 70) && totalAssessments > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (meets(aidProvisionRate, 40) && below(aidProvisionRate, 65) && totalAids > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (below(refresherCompletionRate, 70) && refreshersDue > 0) {
    recommendations.push({
      rank: ++rank,
      recommendation:
  ...
  if (meets(homePracticeCompletionRate, 50) && below(homePracticeCompletionRate, 70) && homePracticeAssigned > 0) {
    insights.push({
  ...
  if (meets(childInvolvementRate, 50) && below(childInvolvementRate, 70) && totalAssessments > 0) {
    insights.push({
  ...
  if (meets(supportPlanReviewRate, 50) && below(supportPlanReviewRate, 70) && totalAssessments > 0) {
    insights.push({
  ...
  if (meets(therapyAttendanceRate, 50) && below(therapyAttendanceRate, 70) && totalTherapySessions > 0) {
    insights.push({
  ...
  if (below(refresherCompletionRate, 50) && refreshersDue > 0) {
    insights.push({
  ...
  if (meets(assessmentCoverageRate, 90) && meets(childInvolvementRate, 90) && totalAssessments > 0) {
    insights.push({
  ...
  if (meets(therapyEngagementRate, 90) && meets(therapyAttendanceRate, 90) && totalTherapySessions > 0) {
    insights.push({
  ...
  if (meets(inclusivePracticeRate, 85) && meets(feedbackPositiveRate, 90) && totalInclusivePractice > 0) {
    insights.push({
  ...
  if (meets(staffTrainingRate, 85) && meets(practiceApplicationRate, 90) && totalTrainingRecords > 0) {
    insights.push({
  ...
  if (meets(aidProvisionRate, 85) && meets(aidChildFeedbackRate, 90) && totalAids > 0) {
    insights.push({
  ...
  if (meets(childViewsRate, 90) && meets(outcomesSharedRate, 90) && totalAssessments > 0) {
    insights.push({
  ...
  if (totalTherapySessions > 0 && meets(avgTherapyProgress, 4.0) && meets(targetsMetRate, 80)) {
    insights.push({
