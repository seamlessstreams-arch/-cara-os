// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/library — List and Query Generated Content
//
...
import { libraryQuerySchema } from "@/lib/aria-studio/schemas";
import { getUserIdFromRequest } from "@/lib/auth-guard";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { GenerationStatus } from "@/lib/aria-studio/types";
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (error) {
      console.error("[aria-studio/library] Query failed:", error);
      return NextResponse.json(
    ...
    console.error("[aria-studio/library] Error:", err);
    return NextResponse.json(
