...
intelligenceStore.childExperience = [
  // Casey — week 1 (baseline)
  {
    ...
    home_id: "home_oak",
    child_id: "yp_casey",
    period_start: seedDay(-21),
    period_end: seedDay(-15),
    safety_score: 72,
    belonging_score: 61,
    regulation_score: 58,
    engagement_score: 65,
    ...
    evidence_refs: [
      { type: "daily_log", id: "log_jas_001", date: seedDay(-19), excerpt: "Joined staff in the kitchen unprompted to help with dinner", significance: "belonging indicator" },
      { type: "incident", id: "inc_jas_001", date: seedDay(-17), excerpt: "Distressed by phone call from mother — co-regulation successful", significance: "regulation capacity noted" },
    ],
    computed_by: "cara",
    reviewed_by: "staff_darren",
    created_at: `${seedDay(-14)}T07:00:00Z`,
  },
  // Casey — week 2 (improvement)
  {
    ...
    home_id: "home_oak",
    child_id: "yp_casey",
    period_start: seedDay(-14),
    period_end: seedDay(-8),
    safety_score: 76,
    belonging_score: 68,
    regulation_score: 63,
    engagement_score: 71,
    ...
    evidence_refs: [
      { type: "daily_log", id: "log_jas_010", date: seedDay(-11), excerpt: "Casey said 'I actually like it here' to key worker during evening 1:1", significance: "belonging — direct voice evidence" },
      { type: "voice_record", id: "vrc_jas_001", date: seedDay(-10), excerpt: "Wants to start a creative writing club at school", significance: "education engagement and aspirations" },
    ],
    computed_by: "cara",
    reviewed_by: null,
    created_at: `${seedDay(-7)}T07:00:00Z`,
  },
  // Alex — week 1
  {
    id: "ces_mar_001",
    ...
    evidence_refs: [
      { type: "incident", id: "inc_mar_001", date: seedDay(-18), excerpt: "Alex left the home for 2 hours without permission following staff redirect", significance: "regulation and boundary difficulties" },
      { type: "daily_log", id: "log_mar_003", date: seedDay(-16), excerpt: "Accepted hot chocolate from Samuel at 22:30 — first positive contact", significance: "early trust indicator" },
    ],
    computed_by: "cara",
    reviewed_by: "staff_darren",
    created_at: `${seedDay(-14)}T07:00:00Z`,
  ...
  // Alex — week 2 (slight improvement)
  {
    ...
    evidence_refs: [
      { type: "daily_log", id: "log_mar_015", date: seedDay(-9), excerpt: "Alex helped Samuel wash the car — talked about his old dog. First sustained 1:1 conversation.", significance: "relational progress" },
    ],
    computed_by: "cara",
    reviewed_by: null,
    created_at: `${seedDay(-7)}T07:00:00Z`,
  ...
  // Jordan — week 2 (stable, high-functioning)
  {
    ...
    evidence_refs: [
      { type: "voice_record", id: "vrc_len_001", date: seedDay(-12), excerpt: "Said she wants to stay at Chamberlain House until she moves into supported living at 18", significance: "stability and future planning" },
      { type: "daily_log", id: "log_len_008", date: seedDay(-10), excerpt: "Received GCSE commendation letter from school — shared it with the team at dinner", significance: "achievement and belonging" },
    ],
    computed_by: "cara",
    reviewed_by: "staff_darren",
    created_at: `${seedDay(-7)}T07:00:00Z`,
...
intelligenceStore.patternAlerts = [
  {
    ...
    status: "active",
    evidence_refs: [
      { type: "incident", id: "inc_mar_001", date: seedDay(-18), excerpt: "Unauthorised absence following staff redirect at 17:30" },
      { type: "incident", id: "inc_mar_002", date: seedDay(-15), excerpt: "Verbal aggression towards staff at 18:15 — de-escalated after 40 minutes" },
      { type: "daily_log", id: "log_mar_009", date: seedDay(-13), excerpt: "Alex refused dinner and isolated in room from 17:00–19:30" },
    ],
    reflective_prompt:
    ...
    detected_at: `${seedDay(-12)}T06:00:00Z`,
    period_start: seedDay(-19),
    period_end: seedDay(-12),
    acknowledged_by: null,
    acknowledged_at: null,
    resolved_by: null,
    resolved_at: null,
    created_at: `${seedDay(-12)}T06:00:00Z`,
  },
  {
    id: "pat_002",
    home_id: "home_oak",
    ...
    status: "acknowledged",
    evidence_refs: [
      { type: "daily_log", id: "log_jas_004", date: seedDay(-17), excerpt: "Distressed after phone contact with mother — cried for 45 mins, refused to engage" },
      { type: "daily_log", id: "log_jas_019", date: seedDay(-10), excerpt: "Quieter than usual following contact visit — went to room early" },
      { type: "incident", id: "inc_jas_002", date: seedDay(-3), excerpt: "Casey distressed post-contact, required co-regulation for 30 minutes" },
    ],
    reflective_prompt:
    ...
    detected_at: `${seedDay(-2)}T06:00:00Z`,
    period_start: seedDay(-19),
    period_end: seedDay(-2),
    acknowledged_by: "staff_darren",
    acknowledged_at: `${seedDay(-2)}T09:30:00Z`,
    resolved_by: null,
    resolved_at: null,
    created_at: `${seedDay(-2)}T06:00:00Z`,
  },
  {
    id: "pat_003",
    home_id: "home_oak",
    ...
    status: "active",
    evidence_refs: [
      { type: "shift", id: "shift_004", date: seedDay(-13), excerpt: "Agency staff (Alex Obi) — evening shift" },
      { type: "shift", id: "shift_009", date: seedDay(-10), excerpt: "Agency staff — evening shift. Two incidents on same shift." },
    ],
    reflective_prompt:
    ...
    detected_at: `${seedDay(-5)}T06:00:00Z`,
    period_start: seedDay(-19),
    period_end: seedDay(-5),
    acknowledged_by: null,
    acknowledged_at: null,
    resolved_by: null,
    resolved_at: null,
    created_at: `${seedDay(-5)}T06:00:00Z`,
  },
  {
    id: "pat_004",
    home_id: "home_oak",
    ...
    status: "resolved",
    evidence_refs: [
      { type: "daily_log", id: "log_len_008", date: seedDay(-10), excerpt: "GCSE commendation letter received and shared with the team" },
    ],
    reflective_prompt:
    ...
    detected_at: `${seedDay(-8)}T06:00:00Z`,
    period_start: seedDay(-50),
    period_end: seedDay(-8),
    acknowledged_by: "staff_darren",
    acknowledged_at: `${seedDay(-8)}T10:00:00Z`,
    resolved_by: "staff_darren",
    resolved_at: `${seedDay(-6)}T09:00:00Z`,
    created_at: `${seedDay(-8)}T06:00:00Z`,
  },
];
...
intelligenceStore.interventions = [
  {
    ...
    outcome_notes: null,
    evidence_refs: [
      { type: "pattern_alert", id: "pat_001", date: seedDay(-12), excerpt: "Escalating dysregulation — 3 episodes in 7 days, all 17–19:00" },
    ],
    created_by: "staff_darren",
    created_at: `${seedDay(-10)}T11:00:00Z`,
    updated_at: `${seedDay(-10)}T11:00:00Z`,
  },
  {
    id: "int_002",
    home_id: "home_oak",
    ...
    outcome_notes: null,
    evidence_refs: [
      { type: "pattern_alert", id: "pat_002", date: seedDay(-2), excerpt: "Post-contact distress pattern — 3 occurrences in 3 weeks" },
    ],
    created_by: "staff_darren",
    created_at: `${seedDay(-1)}T09:00:00Z`,
    updated_at: `${seedDay(-1)}T09:00:00Z`,
  },
  {
    id: "int_003",
    home_id: "home_oak",
    ...
    evidence_refs: [
      { type: "pattern_alert", id: "pat_004", date: seedDay(-8), excerpt: "Sustained education achievement — 6 weeks full attendance" },
    ],
    created_by: "staff_ryan",
    created_at: `${seedDay(-5)}T14:00:00Z`,
    updated_at: `${seedDay(-5)}T14:00:00Z`,
  },
];
...
intelligenceStore.relationalRecords = [
  {
    ...
    title: "Samuel — preferred staff member",
    description:
      "Alex has shown a consistent preference for Samuel. He accepts co-regulation from Samuel more readily than other staff, and the car-washing conversation on 11 April was the first sustained interaction Alex has had with any adult since placement. Samuel should be prioritised as Alex's key worker and primary contact for high-stakes moments.",
    ...
    created_by: "staff_darren",
    created_at: `${seedDay(-8)}T09:00:00Z`,
  },
  {
    id: "rr_002",
    home_id: "home_oak",
    ...
    created_by: "staff_darren",
    created_at: `${seedDay(-12)}T10:00:00Z`,
  },
  {
    id: "rr_003",
    home_id: "home_oak",
    ...
    created_at: `${seedDay(-11)}T11:00:00Z`,
  },
  {
    id: "rr_004",
    home_id: "home_oak",
    ...
    created_at: `${seedDay(-19)}T19:30:00Z`,
  },
  {
    id: "rr_005",
    home_id: "home_oak",
    ...
    source_ref_id: null,
    created_by: "staff_ryan",
    created_at: `${seedDay(-13)}T12:00:00Z`,
  },
  {
    id: "rr_006",
    home_id: "home_oak",
    ...
    created_by: "staff_darren",
    created_at: `${seedDay(-12)}T09:00:00Z`,
  },
  {
    id: "rr_007",
    home_id: "home_oak",
    ...
    created_by: "staff_ryan",
    created_at: `${seedDay(-9)}T10:00:00Z`,
  },
];
...
intelligenceStore.practiceBank = [
  {
    ...
    reviewed_by: "staff_darren",
    reviewed_at: `${seedDay(-7)}T09:00:00Z`,
    is_active: true,
    created_by: "staff_lackson",
    created_at: `${seedDay(-8)}T09:00:00Z`,
    updated_at: `${seedDay(-7)}T09:00:00Z`,
  },
  {
    id: "pb_002",
    home_id: "home_oak",
    ...
    reviewed_by: "staff_darren",
    reviewed_at: `${seedDay(-10)}T10:00:00Z`,
    is_active: true,
    created_by: "staff_darren",
    created_at: `${seedDay(-10)}T09:30:00Z`,
    updated_at: `${seedDay(-10)}T10:00:00Z`,
  },
  {
    id: "pb_003",
    home_id: "home_oak",
    ...
    reviewed_at: `${seedDay(-12)}T11:00:00Z`,
    is_active: true,
    created_by: "staff_chervelle",
    created_at: `${seedDay(-14)}T16:00:00Z`,
    updated_at: `${seedDay(-12)}T11:00:00Z`,
  },
  {
    id: "pb_004",
    home_id: "home_oak",
    ...
    is_active: true,
    created_by: "staff_ryan",
    created_at: `${seedDay(-10)}T14:00:00Z`,
    updated_at: `${seedDay(-10)}T14:00:00Z`,
  },
  {
    id: "pb_005",
    home_id: "home_oak",
    ...
    contributed_by: "staff_ryan",
    reviewed_by: "staff_darren",
    reviewed_at: `${seedDay(-8)}T09:00:00Z`,
    is_active: true,
    created_by: "staff_ryan",
    created_at: `${seedDay(-9)}T11:00:00Z`,
    updated_at: `${seedDay(-8)}T09:00:00Z`,
  },
  {
    id: "pb_006",
    home_id: "home_oak",
    ...
    is_active: true,
    created_by: "staff_ryan",
    created_at: `${seedDay(-10)}T15:00:00Z`,
    updated_at: `${seedDay(-10)}T15:00:00Z`,
  },
];
...
intelligenceStore.voiceRecords = [
  {
    ...
    home_id: "home_oak",
    child_id: "yp_casey",
    recorded_at: `${seedDay(-10)}T15:30:00Z`,
    theme: "wishes",
    ...
    created_at: `${seedDay(-10)}T16:00:00Z`,
  },
  {
    id: "vrc_jas_002",
    home_id: "home_oak",
    child_id: "yp_casey",
    recorded_at: `${seedDay(-2)}T19:00:00Z`,
    theme: "feelings",
    ...
    created_at: `${seedDay(-2)}T19:30:00Z`,
  },
  {
    id: "vrc_len_001",
    home_id: "home_oak",
    child_id: "yp_jordan",
    recorded_at: `${seedDay(-12)}T17:00:00Z`,
    theme: "plans",
    ...
    source_ref_id: null,
    recorded_by: "staff_ryan",
    created_at: `${seedDay(-12)}T17:30:00Z`,
  },
  {
    id: "vrc_len_002",
    home_id: "home_oak",
    child_id: "yp_jordan",
    recorded_at: `${seedDay(-6)}T16:00:00Z`,
    theme: "future",
    ...
    source_ref_id: null,
    recorded_by: "staff_ryan",
    created_at: `${seedDay(-6)}T16:30:00Z`,
  },
  {
    id: "vrc_mar_001",
    home_id: "home_oak",
    child_id: "yp_alex",
    recorded_at: `${seedDay(-9)}T21:00:00Z`,
    theme: "relationships",
    direct_quote: "Samuel's alright. He doesn't make it weird.",
    paraphrase: "During the car-washing session, Alex made an unprompted positive comment about Samuel, indicating emerging trust.",
    capture_method: "observed",
    action_taken: "Samuel identified as preferred adult. Key worker allocation reviewed. Proactive transition support plan assigned to Samuel where possible.",
    action_owner: "staff_darren",
    action_outcome: null,
    voice_heeded: true,
    source_ref_type: "daily_log",
    ...
    created_at: `${seedDay(-9)}T21:30:00Z`,
  },
];
...
intelligenceStore.homeClimate = [
  {
    id: "hcs_001",
    home_id: "home_oak",
    period_start: seedDay(-27),
    period_end: seedDay(-21),
    ...
    risk_flags: [],
    computed_by: "cara",
    created_at: `${seedDay(-20)}T06:00:00Z`,
  },
  {
    id: "hcs_002",
    home_id: "home_oak",
    period_start: seedDay(-20),
    period_end: seedDay(-14),
    ...
    computed_by: "cara",
    created_at: `${seedDay(-13)}T06:00:00Z`,
  },
  {
    id: "hcs_003",
    home_id: "home_oak",
    period_start: seedDay(-13),
    period_end: seedDay(-7),
    ...
    computed_by: "cara",
    created_at: `${seedDay(-6)}T06:00:00Z`,
  },
];
...
intelligenceStore.docJobs = [
  {
    ...
    created_by: "staff_darren",
    created_at: `${seedDay(-14)}T10:00:00Z`,
    updated_at: `${seedDay(-14)}T10:45:00Z`,
  },
  {
    id: "dij_002",
    home_id: "home_oak",
    ...
    classification: {
      ...
      key_dates: [seedDay(-12), seedDay(2)],
      risks_identified: [],
    ...
    reviewed_by: "staff_darren",
    reviewed_at: `${seedDay(-12)}T14:00:00Z`,
    placed_at: `${seedDay(-12)}T14:05:00Z`,
    ...
    created_by: "staff_darren",
    created_at: `${seedDay(-12)}T13:30:00Z`,
    updated_at: `${seedDay(-12)}T14:05:00Z`,
  },
  {
    id: "dij_003",
    home_id: "home_oak",
    ...
    created_at: `${seedDay(-1)}T11:00:00Z`,
    updated_at: `${seedDay(-1)}T11:00:00Z`,
  },
];
...
intelligenceStore.actionOutcomes = [
  {
    ...
    created_by: "staff_darren",
    created_at: `${seedDay(-12)}T14:10:00Z`,
    updated_at: `${seedDay(-12)}T14:10:00Z`,
  },
  {
    id: "ao_002",
    home_id: "home_oak",
    ...
    should_continue: null,
    created_by: "staff_darren",
    created_at: `${seedDay(-14)}T11:00:00Z`,
    updated_at: `${seedDay(-14)}T11:00:00Z`,
  },
  {
    id: "ao_003",
    home_id: "home_oak",
    ...
    should_continue: null,
    created_by: "staff_darren",
    created_at: `${seedDay(-10)}T11:30:00Z`,
    updated_at: `${seedDay(-10)}T11:30:00Z`,
  },
  {
    id: "ao_004",
    home_id: "home_oak",
    ...
    owner_id: "staff_ryan",
    due_date: seedDay(0),
    completed_at: `${seedDay(0)}T15:00:00Z`,
    ...
    created_by: "staff_ryan",
    created_at: `${seedDay(-12)}T18:00:00Z`,
    updated_at: `${seedDay(0)}T15:30:00Z`,
  },
  {
    id: "ao_005",
    home_id: "home_oak",
    ...
    should_continue: null,
    created_by: "staff_darren",
    created_at: `${seedDay(-20)}T10:00:00Z`,
    updated_at: `${seedDay(-20)}T10:00:00Z`,
  },
  {
    id: "ao_006",
    home_id: "home_oak",
    ...
    should_continue: null,
    created_by: "staff_darren",
    created_at: `${seedDay(-15)}T09:00:00Z`,
    updated_at: `${seedDay(-15)}T09:00:00Z`,
  },
];
...
intelligenceStore.caraAssessments = [
  {
    ...
    created_by: "staff_darren",
    reviewed_by: "staff_darren",
    created_at: `${seedDay(-5)}T10:00:00Z`,
    reviewed_at: `${seedDay(-5)}T14:00:00Z`,
  },
];
...
intelligenceStore.keyWorkSessions = [
  {
    ...
    status: "planned",
    created_by: "staff_darren",
    created_at: `${seedDay(-5)}T10:30:00Z`,
  },
  {
    id: "kws_002",
    home_id: "home_oak",
    ...
    status: "planned",
    created_by: "staff_darren",
    created_at: `${seedDay(-4)}T09:00:00Z`,
  },
];
...
intelligenceStore.caraSafeguardingFlags = [
  {
    ...
    status: "open",
    created_at: `${seedDay(-4)}T09:30:00Z`,
  },
];
...
intelligenceStore.riChallengeLogs = [
  {
    ...
    action_due_date: seedDay(-4),
    status: "action_pending",
    cara_generated: false,
    created_by: "staff_darren",
    created_at: `${seedDay(-6)}T10:00:00Z`,
    updated_at: `${seedDay(-6)}T10:00:00Z`,
  },
  {
    id: "ric_002",
    home_id: "home_oak",
    ...
    manager_response: "Acknowledged. Supervision sessions have been scheduled for both staff members on 17 April (Anna) and 19 April (Naomi). Apologies for the delay — staffing pressures were a factor.",
    manager_responded_at: `${seedDay(-6)}T16:30:00Z`,
    ...
    action_due_date: seedDay(1),
    status: "responded",
    cara_generated: false,
    created_by: "staff_darren",
    created_at: `${seedDay(-7)}T09:30:00Z`,
    updated_at: `${seedDay(-6)}T16:30:00Z`,
  },
  {
    id: "ric_003",
    home_id: "home_oak",
    ...
    evidence_summary: "The training matrix shows Marcus B and Samuel M have expired first aid certifications (expired February 2026 and March 2026 respectively). Marcus B also has an expired Level 3 safeguarding certificate. Both staff continue to be rostered on solo-cover shifts. This presents a compliance and safety risk.",
    ...
    escalation_level: "elevated",
    action_required: "Rebook and confirm first aid training for Marcus B and Samuel M. Rebook Level 3 safeguarding for Marcus B. Adjust rota to ensure compliant cover.",
    action_due_date: seedDay(24),
    status: "open",
    cara_generated: false,
    created_by: "staff_darren",
    created_at: `${seedDay(-8)}T11:00:00Z`,
    updated_at: `${seedDay(-8)}T11:00:00Z`,
  },
  {
    id: "ric_004",
    home_id: "home_oak",
    ...
    manager_responded_at: `${seedDay(-5)}T10:00:00Z`,
    manager_responded_by: "staff_edward",
    ...
    action_due_date: seedDay(2),
    status: "responded",
    cara_generated: false,
    created_by: "staff_darren",
    created_at: `${seedDay(-5)}T09:00:00Z`,
    updated_at: `${seedDay(-5)}T10:00:00Z`,
  },
];
...
intelligenceStore.riAlerts = [
  {
    ...
    data_evidence: { mfc_episodes: 3, contextual_risk: true, mash_referral_pending: true, last_episode: seedDay(-19) },
    is_resolved: false,
    auto_generated: true,
    linked_challenge_id: "ric_001",
    created_by: "cara",
    created_at: `${seedDay(-6)}T08:00:00Z`,
  },
  {
    id: "ria_002",
    home_id: "home_oak",
    ...
    data_evidence: { expired_staff: ["staff_ryan", "staff_lackson"], expired_types: ["first_aid", "safeguarding_l3"], last_checked: seedDay(-8) },
    is_resolved: false,
    auto_generated: true,
    linked_challenge_id: "ric_003",
    created_by: "cara",
    created_at: `${seedDay(-8)}T08:00:00Z`,
  },
  {
    id: "ria_003",
    home_id: "home_oak",
    ...
    description: "Priya S and Naomi R have not received formal supervision in over 5 weeks. This falls below the regulatory requirement and has been formally challenged. Supervisions are now scheduled but not yet completed.",
    data_evidence: { overdue_staff: ["staff_anna", "staff_chervelle"], weeks_overdue: [5.5, 5], scheduled: true },
    is_resolved: false,
    auto_generated: true,
    linked_challenge_id: "ric_002",
    created_by: "cara",
    created_at: `${seedDay(-7)}T08:00:00Z`,
  },
  {
    id: "ria_004",
    home_id: "home_oak",
    ...
    auto_generated: true,
    created_by: "cara",
    created_at: `${seedDay(-9)}T08:00:00Z`,
  },
  // ── Historically resolved alerts (evidence for Reg 45) ───────────────────
  {
    ...
    is_resolved: true,
    resolved_at: `${seedDay(-31)}T11:00:00Z`,
    ...
    auto_generated: true,
    created_by: "cara",
    created_at: `${seedDay(-50)}T08:00:00Z`,
  },
  {
    id: "ria_006",
    home_id: "home_oak",
  ...
  // ── Additional alerts for richer dataset ───────────────────────────────────
  {
    ...
    data_evidence: { scheduled_date: seedDay(-2), days_overdue: 12, last_drill: seedDay(-36) },
    is_resolved: false,
    auto_generated: true,
    created_by: "cara",
    created_at: `${seedDay(10)}T07:00:00Z`,
  },
  {
    id: "ria_008",
    home_id: "home_oak",
  ...
  },
  {
    ...
    auto_generated: true,
    created_by: "cara",
    created_at: `${seedDay(7)}T14:00:00Z`,
  },
  // ── More resolved alerts for history ────────────────────────────────────────
  {
    ...
    is_resolved: true,
    resolved_at: `${seedDay(-23)}T14:00:00Z`,
    resolved_by: "staff_darren",
    ...
    auto_generated: true,
    created_by: "cara",
    created_at: `${seedDay(-36)}T08:00:00Z`,
  },
  {
    id: "ria_012",
    home_id: "home_oak",
    ...
    is_resolved: true,
    resolved_at: `${seedDay(-59)}T16:00:00Z`,
    ...
    auto_generated: true,
    created_by: "cara",
    created_at: `${seedDay(-69)}T08:00:00Z`,
  },
  {
    id: "ria_013",
    home_id: "home_oak",
    ...
    is_resolved: true,
    resolved_at: `${seedDay(-15)}T11:00:00Z`,
    resolved_by: "staff_darren",
    ...
    auto_generated: true,
    created_by: "cara",
    created_at: `${seedDay(-26)}T08:00:00Z`,
  },
  {
    id: "ria_014",
    home_id: "home_oak",
    ...
    is_resolved: true,
    resolved_at: `${seedDay(-12)}T09:00:00Z`,
    resolved_by: "staff_darren",
    ...
    auto_generated: true,
    created_by: "cara",
    created_at: `${seedDay(-19)}T08:00:00Z`,
  },
];
...
intelligenceStore.reg44Visits = [
  {
    ...
    home_id: "home_oak",
    visit_number: 1,
    visit_date: seedDay(-96),
    scheduled_date: seedDay(-96),
    visitor_name: "Patricia Osei",
    visitor_organisation: "Osei Independent Consultancy",
    status: "ri_reviewed",
    report_received_date: seedDay(-88),
    ...
    findings: [
      ...
      },
      {
        ...
        action_completed_at: `${seedDay(-83)}T10:00:00Z`,
    ...
    manager_response_date: `${seedDay(-83)}T11:00:00Z`,
    manager_response_by: "staff_darren",
    ri_review_date: `${seedDay(-76)}T09:00:00Z`,
    ri_review_by: "staff_alicia",
    ...
    created_at: `${seedDay(-88)}T14:00:00Z`,
    created_by: "staff_darren",
    updated_at: `${seedDay(-76)}T09:00:00Z`,
  },
  {
    id: "r44_002",
    home_id: "home_oak",
    visit_number: 2,
    visit_date: seedDay(-61),
    scheduled_date: seedDay(-61),
    visitor_name: "Patricia Osei",
    visitor_organisation: "Osei Independent Consultancy",
    status: "ri_reviewed",
    report_received_date: seedDay(-54),
    report_document_id: null,
    ...
    findings: [
      {
        ...
        action_completed: true,
        action_completed_at: `${seedDay(-41)}T16:00:00Z`,
        action_completed_by: "staff_darren",
      ...
      },
      {
        ...
        action_completed: true,
        action_completed_at: `${seedDay(-51)}T14:00:00Z`,
        action_completed_by: "staff_darren",
    ...
    manager_response_date: `${seedDay(-39)}T10:00:00Z`,
    manager_response_by: "staff_darren",
    ri_review_date: `${seedDay(-33)}T09:00:00Z`,
    ri_review_by: "staff_alicia",
    ...
    created_at: `${seedDay(-54)}T15:00:00Z`,
    created_by: "staff_darren",
    updated_at: `${seedDay(-33)}T09:00:00Z`,
  },
  {
    id: "r44_003",
    home_id: "home_oak",
    visit_number: 3,
    visit_date: seedDay(-27),
    scheduled_date: seedDay(-27),
    visitor_name: "Patricia Osei",
    visitor_organisation: "Osei Independent Consultancy",
    status: "manager_response_submitted",
    report_received_date: seedDay(-19),
    report_document_id: null,
    overall_finding: "concerns_identified",
    findings: [
      {
      ...
      },
      {
        ...
        action_completed: true,
        action_completed_at: `${seedDay(-12)}T12:00:00Z`,
        action_completed_by: "staff_darren",
    ...
    manager_response_date: `${seedDay(-18)}T14:30:00Z`,
    manager_response_by: "staff_darren",
    ri_review_date: null,
    ri_review_by: null,
    ri_comments: null,
    ...
    created_at: `${seedDay(-19)}T09:00:00Z`,
    created_by: "staff_darren",
    updated_at: `${seedDay(-18)}T14:30:00Z`,
  },
  {
    id: "r44_004",
    home_id: "home_oak",
    ...
    ri_comments: null,
    cara_summary: null,
    created_at: `${seedDay(-6)}T09:00:00Z`,
    created_by: "staff_darren",
    updated_at: `${seedDay(-6)}T09:00:00Z`,
  },
];
...
intelligenceStore.carePlans = [
  ...
  // ── Jordan M — Care Plan ─────────────────────────────────────────────────
  {
    ...
    goals: [
      ...
      },
      {
        ...
        actions: [
          "Weekly supervised contact with father — Naomi or Anna to facilitate",
  ...
  // ── Casey T — Care Plan ──────────────────────────────────────────────────
  {
    ...
    goals: [
      {
        ...
        actions: [
          "Medication administered by Naomi consistently — build therapeutic relationship",
        ...
        status: "in_progress",
        progress_note: "One late administration in April (INC-2026-0040). Compliance improving since Naomi took primary role. Casey has engaged with conversation about her medication and now understands the benefits better. GP review requested.",
        target_date: dFN(60),
        achieved_date: null,
      ...
      },
      {
        ...
        status: "in_progress",
        progress_note: "CAMHS referral submitted January 2026. Assessment appointment in June 2026 confirmed. Keywork with Naomi is going well — Casey is engaging and has identified three personal strengths. LIVERS introduced in April keywork.",
        target_date: dFN(60),
        achieved_date: null,
        last_reviewed: dFN(-10),
        reviewed_by: "staff_chervelle",
    ...
    rm_sign_off_by: "staff_darren",
    strengths_summary: "Casey is engaging well with staff, particularly Naomi. She is beginning to open up about her feelings and identity. Medication compliance is improving. CAMHS engagement secured for June.",
...
intelligenceStore.piDebriefs = [
  ...
  },
  {
    ...
    de_escalation_attempted: true,
    de_escalation_description: "Naomi attempted de-escalation for approximately 8 minutes — offered alternative trip options, tried to explore Alex's frustration, offered to call social worker to discuss. Alex became increasingly agitated and made towards the door.",
    injuries: [],
    medical_assessment_completed: true,
...
intelligenceStore.contactLogs = [
  ...
  },
  {
    ...
    gifts_received: false,
    gifts_detail: null,
    cara_analysis: "Contact log for Alex and Sharon (14 April 2026) indicates a significantly improved contact session compared to the previous fortnight. Preparation time with relational key worker Samuel appears to be a protective factor — Alex arrived in a regulated state and the session unfolded naturally. This supports the hypothesis in the care plan that side-by-side activity before high-stakes interactions reduces Alex's anxiety threshold. Recommend: formalise Samuel-led pre-contact preparation in the contact plan. Review Sharon's previous pattern of placement-return comments — one session without this is encouraging but not yet a trend.",
...
intelligenceStore.trainingNeeds = [
  {
    ...
    deadline: seedDay(20),
    created_by: "staff_darren",
    created_at: `${seedDay(-9)}T09:00:00Z`,
    updated_at: `${seedDay(-9)}T09:00:00Z`,
  },
  {
    id: "tn_002",
    home_id: "home_oak",
    ...
    deadline: seedDay(8),
    created_by: "staff_darren",
    created_at: `${seedDay(-6)}T10:30:00Z`,
    updated_at: `${seedDay(-5)}T09:00:00Z`,
  },
  {
    id: "tn_003",
    home_id: "home_oak",
  ...
  },
  {
    ...
    deadline: seedDay(25),
    created_by: "staff_darren",
    created_at: `${seedDay(-5)}T11:00:00Z`,
    updated_at: `${seedDay(-5)}T11:00:00Z`,
  },
  // ── Completed training needs (historical evidence for Reg 45) ─────────────
  {
    ...
    affected_roles: ["residential_care_worker", "senior_residential_care_worker", "deputy_manager"],
    status: "completed",
    completed_at: `${seedDay(-36)}T14:00:00Z`,
    created_by: "staff_darren",
    created_at: `${seedDay(-59)}T09:00:00Z`,
    updated_at: `${seedDay(-36)}T14:00:00Z`,
  },
  {
    id: "tn_006",
    home_id: "home_oak",
    ...
    affected_roles: ["residential_care_worker", "senior_residential_care_worker"],
    status: "completed",
    completed_at: `${seedDay(-23)}T10:00:00Z`,
    created_by: "staff_ryan",
    created_at: `${seedDay(-50)}T11:00:00Z`,
    updated_at: `${seedDay(-23)}T10:00:00Z`,
  },
  {
    id: "tn_007",
    home_id: "home_oak",
    ...
    status: "completed",
    completed_at: `${seedDay(-15)}T16:00:00Z`,
    created_by: "staff_darren",
    created_at: `${seedDay(-41)}T09:00:00Z`,
    updated_at: `${seedDay(-15)}T16:00:00Z`,
  },
];
