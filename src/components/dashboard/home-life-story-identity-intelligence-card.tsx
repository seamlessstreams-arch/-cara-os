...
import type { LifeStoryIdentityRating, HomeLifeStoryIdentityResult } from "@/lib/engines/home-life-story-identity-intelligence-engine";
...
export function HomeLifeStoryIdentityIntelligenceCard() {
  const { data: queryData, isLoading } = useQuery<{ data: HomeLifeStoryIdentityResult }>({
