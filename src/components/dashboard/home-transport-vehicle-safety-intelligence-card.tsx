...
import type { TransportSafetyRating, TransportVehicleSafetyResult } from "@/lib/engines/home-transport-vehicle-safety-intelligence-engine";
...
function useHomeTransportVehicleSafetyIntelligence() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: TransportVehicleSafetyResult }>;
    },
