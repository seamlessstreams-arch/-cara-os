...
export function computeHomeOrganizationalLearning(
  ...
  if (serious_incident_reviews.length === 0 && critical_debriefs.length === 0 && service_improvements.length === 0) {
    return {
      ...
      sir: { total_reviews: 0, completed_reviews: 0, open_reviews: 0, total_lessons_learned: 0, total_actions: 0, actions_completed: 0, actions_overdue: 0, action_completion_rate: null, practice_changes_total: 0 },
      debriefs: { total_debriefs_90d: 0, completed_rate: null, high_impact_count: 0, avg_root_causes: 0, total_training_needs: 0, action_completion_rate: null },
      improvements: { total_improvements: 0, active_improvements: 0, implemented_count: 0, embedded_count: 0, overdue_count: 0, red_rag_count: 0, milestone_achievement_rate: null, by_source: {} },
      strengths: [],
