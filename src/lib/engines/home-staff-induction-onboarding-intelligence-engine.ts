...
export function computeStaffInductionOnboarding(
  ...
  if (allEmpty && total_staff === 0) {
    return {
      ...
      agency_induction_completion_rate: null,
      safeguarding_coverage_rate: null,
      medication_coverage_rate: null,
      fire_safety_coverage_rate: null,
      shadowing_completion_rate: null,
      shadowing_competency_rate: null,
      handbook_acknowledgement_rate: null,
      lone_working_readiness_rate: null,
