// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/formulations — Therapeutic formulations
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { createFormulation, listFormulations, getFormulationForChild } from "@/lib/aria-studio/formulation.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/formulations] GET error:", err);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/formulations] POST error:", err);
