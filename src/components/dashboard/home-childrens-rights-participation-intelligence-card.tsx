...
import type { ChildrensRightsRating, HomeChildrensRightsResult } from "@/lib/engines/home-childrens-rights-participation-intelligence-engine";

interface HomeChildrensRightsResponse {
  data: HomeChildrensRightsResult;
}

function useHomeChildrensRightsParticipationIntelligence() {
