...
export function computeHomeMedicationGovernance(
  ...
  if (
    ...
    return {
      ...
      audit: { total_audits: 0, pass_count: 0, fail_count: 0, action_required_count: 0, pass_rate: null, discrepancy_count: 0, storage_correct_rate: null, temperature_ok_rate: null, labelling_correct_rate: null, follow_up_required_count: 0 },
      errors: { total_errors: 0, by_severity: {}, no_harm_count: 0, minor_harm_count: 0, moderate_harm_count: 0, major_harm_count: 0, debrief_rate: null, root_cause_rate: null, preventive_embedded_rate: null, open_investigations: 0, ofsted_notifiable_count: 0 },
      nearMisses: { total_near_misses: 0, by_risk_grade: {}, high_critical_count: 0, debrief_rate: null, avg_learning_points: 0 },
      stock: { total_checks: 0, balanced_count: 0, discrepancy_count: 0, action_required_count: 0, balanced_rate: null, weekly_checks: 0, monthly_audits: 0, total_discrepant_items: 0 },
      storage: { total_audits: 0, pass_count: 0, pass_with_minor_count: 0, fail_count: 0, pass_rate: null, temperature_compliance_rate: null, expiry_check_rate: null, total_expired_items: 0, controlled_drugs_correct_rate: null, security_pass_rate: null, keys_accounted_rate: null, record_keeping_rate: null, overdue_audits: 0, open_follow_ups: 0 },
      emergencyProtocols: { total_protocols: 0, unique_children: 0, gp_signed_off_rate: null, avg_staff_trained: 0, self_administer_count: 0, recognises_symptoms_count: 0, overdue_reviews: 0, reviews_due_soon: 0 },
      strengths: [],
