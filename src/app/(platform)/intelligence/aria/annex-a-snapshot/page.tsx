...
// ══════════════════════════════════════════════════════════════════════════════
// CORNERSTONE — ARIA ANNEX A LIVE SNAPSHOT
// Point-in-time inspection-readiness snapshot built from verified records.
// ARIA drafts; the manager locks. Locked snapshots are immutable.
// ══════════════════════════════════════════════════════════════════════════════
...
export default function AnnexASnapshotPage() {
  ...
  return (
    <PageShell
      ...
      subtitle="Inspection-readiness snapshot built live from verified records. ARIA drafts; the manager locks. Locked snapshots are immutable."
      actions={
