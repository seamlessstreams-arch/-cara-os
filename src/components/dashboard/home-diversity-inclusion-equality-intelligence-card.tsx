...
import type { DiversityInclusionRating, DiversityInclusionResult } from "@/lib/engines/home-diversity-inclusion-equality-intelligence-engine";
...
export function HomeDiversityInclusionEqualityIntelligenceCard() {
  const { data, isLoading } = useQuery<{ data: DiversityInclusionResult }>({
