...
import type { IndependenceLifeSkillsRating, IndependenceLifeSkillsResult } from "@/lib/engines/home-independence-life-skills-development-intelligence-engine";
...
export function HomeIndependenceLifeSkillsDevelopmentIntelligenceCard() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: IndependenceLifeSkillsResult }>;
    },
