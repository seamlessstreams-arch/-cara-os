...
function useSupervisionIntelligence() {
  return useQuery({
...
// Theme-aware stat tile (see handover-prompt) — --cs tokens stay readable in
// both themes; raw bg-green-50 / text-slate-600 did not under the dark reskin.
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm flex items-center gap-2">
            <ListChecks className="h-4 w-4 text-[--cs-text-muted]" />
            <span className="text-[--cs-text]">Shift Checklist</span>
          </CardTitle>
