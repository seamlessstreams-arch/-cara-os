// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/sources — List and index sources
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { listSources, indexSource } from "@/lib/aria-studio/source.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/sources] GET error:", err);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/sources] POST error:", err);
