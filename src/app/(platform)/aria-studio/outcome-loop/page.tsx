...
// ══════════════════════════════════════════════════════════════════════════════
// ARIA STUDIO — OUTCOME LOOP DASHBOARD
//
// Tracks whether ARIA's outputs lead to real outcomes. Shows completion rates
// for committed artifacts and their linked actions. Helps managers see
// the real-world impact of ARIA-generated content over time.
// ══════════════════════════════════════════════════════════════════════════════
...
export default function OutcomeLoopPage() {
  ...
  return (
    <PageShell title="Outcome Loop" subtitle="Tracking real-world impact of ARIA outputs">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-[var(--cs-text-secondary)] mt-0.5">
                Did the action plan get completed? Did the key work session happen? Track whether ARIA outputs lead to real outcomes.
              </p>
            </div>
          </div>
        </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--cs-text-secondary)] mt-1 leading-relaxed">
                    {summary.completionRate >= 75
                      ? "Strong outcome loop — the majority of ARIA-generated actions are being completed. This indicates good integration between ARIA outputs and daily practice."
                      : summary.completionRate >= 50
                        ...
                        : "The outcome loop needs attention — fewer than half of ARIA-generated actions are being completed. This may indicate that actions are too ambitious, staff capacity is stretched, or follow-up processes need strengthening."}
                  </p>
                </div>
              </div>
            </div>
