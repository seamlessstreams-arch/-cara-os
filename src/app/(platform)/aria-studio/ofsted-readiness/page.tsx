...
// ══════════════════════════════════════════════════════════════════════════════
// ARIA STUDIO — OFSTED READINESS DASHBOARD
//
...
export default function OfstedReadinessDashboard() {
  ...
  return (
    <PageShell title="Ofsted Readiness" subtitle="ARIA Studio Compliance Intelligence">
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg p-4 text-center" style={{ backgroundColor: "var(--cs-surface-alt)" }}>
            <p className="text-xs" style={{ color: "var(--cs-text-secondary)" }}>
              This readiness assessment is generated by ARIA based on available evidence. It is a professional aid, not a prediction of inspection outcome.
