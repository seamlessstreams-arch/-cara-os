...
import type { DbsVettingRating, DbsVettingResult } from "@/lib/engines/home-dbs-renewal-staff-vetting-intelligence-engine";
...
export function HomeDbsRenewalStaffVettingIntelligenceCard() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: DbsVettingResult }>;
    },
