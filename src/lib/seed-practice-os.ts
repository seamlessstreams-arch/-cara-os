...
export const PRACTICE_OS_RESTRAINTS: RestraintRecord[] = [
  {
    ...
    linked_incident_id: "",
    notifications_sent: [{ party: "Placing authority", date: daysAgo(35) }, { party: "Parent", date: daysAgo(35) }],
  ...
  },
  {
    ...
    reviewed_by: "staff_darren",
    linked_incident_id: "",
    notifications_sent: [{ party: "Placing authority", date: daysAgo(22) }],
    body_map_completed: true,
    medical_check_completed: true,
    recorded_by: "staff_edward",
  ...
  },
  {
    ...
    injuries: [{ person: "child", injury: "Minor bruise, left forearm — sustained in the struggle, not the hold", treatment: "Checked by ambulance crew; no further treatment" }],
