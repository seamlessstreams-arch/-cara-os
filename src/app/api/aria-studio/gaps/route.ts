// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/gaps — List and detect evidence gaps
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { detectGaps } from "@/lib/aria-studio/gap-detection.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/gaps] Error:", err);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/gaps] POST error:", err);
