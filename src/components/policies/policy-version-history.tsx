...
// ── Inlined from use-policy-versions ─────────────────────────────────────────
...
function usePolicyVersionHistory(policyId: string, enabled: boolean) {
  return useQuery({
...
interface RecordPolicyVersionInput {
  policyId: string;
...
function useRecordPolicyVersion() {
