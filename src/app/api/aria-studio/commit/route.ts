// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/commit — Commit Approved Content to Target Record
//
...
import { commitRequestSchema } from "@/lib/aria-studio/schemas";
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (linkError) {
      console.error("[aria-studio/commit] Commit link insert failed:", linkError);
      return NextResponse.json(
    ...
    console.error("[aria-studio/commit] Error:", err);
    return NextResponse.json(
