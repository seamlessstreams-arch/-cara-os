// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/early-warnings — Early warning indicators
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { runEarlyWarningChecks, listEarlyWarnings } from "@/lib/aria-studio/early-warning.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/early-warnings] GET error:", err);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/early-warnings] POST error:", err);
