...
describe("computeComplaintMetrics", () => {
  ...
  describe("empty complaints", () => {
    ...
    it("returns zero acknowledged_rate", () => {
      expect(computeComplaintMetrics([]).acknowledged_rate).toBeNull();; });

    it("returns zero investigation_started_rate", () => {
      expect(computeComplaintMetrics([]).investigation_started_rate).toBeNull();; });

    it("returns zero resolved_within_28_days_rate", () => {
      expect(computeComplaintMetrics([]).resolved_within_28_days_rate).toBeNull();; });

    it("returns zero average_days_to_resolution", () => {
      expect(computeComplaintMetrics([]).average_days_to_resolution).toBeNull();; });

    it("returns zero learning_identified_rate", () => {
      expect(computeComplaintMetrics([]).learning_identified_rate).toBeNull();; });
    ...
    it("returns zero satisfaction_rate", () => {
      expect(computeComplaintMetrics([]).satisfaction_rate).toBeNull();; });
  ...
  describe("resolved_within_28_days_rate", () => {
    it("is 0 when all resolved_within_28_days are null", () => {
      ...
      expect(computeComplaintMetrics(c).resolved_within_28_days_rate).toBeNull();; });
  ...
  describe("average_days_to_resolution", () => {
    it("is 0 when all days_to_resolution are null", () => {
      ...
      expect(computeComplaintMetrics(c).average_days_to_resolution).toBeNull();; });
  ...
  describe("satisfaction_rate", () => {
    it("is 0 when all complainant_satisfaction are null", () => {
      ...
      expect(computeComplaintMetrics(c).satisfaction_rate).toBeNull();; });
