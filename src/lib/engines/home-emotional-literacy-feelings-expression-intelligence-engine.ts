...
function emptyResult(
  ...
  return {
    ...
    headline,
    emotion_identification_rate: null,
    vocabulary_breadth_rate: null,
    expression_tool_rate: null,
    journal_engagement_rate: null,
    staff_attunement_rate: null,
    child_progress_rate: null,
    total_assessments: 0,
    children_assessed: 0,
    avg_identification_score: 0,
    nuanced_emotion_rate: null,
    self_recognition_rate: null,
    empathy_rate: null,
    context_understanding_rate: null,
    avg_vocabulary_words: 0,
    spontaneous_use_rate: null,
    creative_expression_rate: null,
    vocabulary_progress_rate: null,
    total_tools_available: 0,
    unique_tool_types: 0,
    child_initiated_tool_use_rate: null,
    tool_accessibility_rate: null,
    avg_tool_effectiveness: 0,
    total_journal_entries: 0,
    children_journaling: 0,
    child_initiated_journal_rate: null,
    staff_response_rate: null,
    avg_journal_depth: 0,
    journal_keywork_link_rate: null,
    total_attunement_observations: 0,
    emotional_recognition_rate: null,
    appropriate_response_rate: null,
    validation_rate: null,
    co_regulation_rate: null,
    missed_cues_rate: null,
    repair_rate: null,
