// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria-studio/home-dynamics — Home dynamics snapshots
// ══════════════════════════════════════════════════════════════════════════════

import { NextRequest, NextResponse } from "next/server";
import { generateHomeDynamicsSnapshot, getLatestSnapshot, listSnapshots } from "@/lib/aria-studio/home-dynamics.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/home-dynamics] GET error:", err);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("[aria-studio/home-dynamics] POST error:", err);
