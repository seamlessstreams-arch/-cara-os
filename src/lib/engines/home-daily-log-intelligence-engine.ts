...
export function computeHomeDailyLog(
  ...
  if ((total_children === 0 && total_staff === 0) || daily_logs.length === 0) {
    return {
      ...
      entry_types: { by_type: {}, types_used: [], types_missing: [...ALL_ENTRY_TYPES], type_diversity_rate: null },
      mood: { entries_with_mood: 0, mood_tracking_rate: null, avg_mood_score: 0, low_mood_count: 0, high_mood_count: 0 },
      staff: { unique_staff_14d: 0, staff_participation_rate: null, most_active_staff_entries: 0, least_active_staff_entries: 0 },
      child_coverage: { children_with_entries_14d: 0, children_without: total_children, child_coverage_rate: null, entries_per_child: {} },
      quality: { significant_entries: 0, significant_rate: null, avg_content_length: 0, incident_linked_count: 0 },
      strengths: [],
