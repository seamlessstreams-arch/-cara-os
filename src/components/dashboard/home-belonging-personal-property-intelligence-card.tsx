        ...
        {d.belonging_rating !== "insufficient_data" && (
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-1.5">
            ...
            <div className={cn("text-center rounded-lg p-1.5", (d.property_loss_rate !== null && d.property_loss_rate <= 0.5) ? "bg-green-50" : (d.property_loss_rate !== null && d.property_loss_rate <= 2) ? "bg-amber-50" : "bg-red-50")}>
              <p className={cn("text-sm font-bold tabular-nums", (d.property_loss_rate !== null && d.property_loss_rate <= 0.5) ? "text-[--cs-success]" : (d.property_loss_rate !== null && d.property_loss_rate <= 2) ? "text-[--cs-warning]" : "text-[--cs-risk]")}>{d.property_loss_rate}</p>
