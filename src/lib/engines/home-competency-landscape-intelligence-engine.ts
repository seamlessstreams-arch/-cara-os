...
export function computeHomeCompetencyLandscape(
  ...
  const readiness: ReadinessProfile = {
    avg_readiness_score: avg(scores.filter((v): v is number => v !== null)),
...
function emptyResult(): HomeCompetencyLandscapeResult {
  return {
    ...
    readiness: {
      ...
      lowest_readiness: 0,
      staff_above_70: 0,
      staff_above_70_rate: null,
      staff_with_target: 0,
      staff_with_target_rate: null,
    },
    stage_distribution: [],
    progression: {
      active_plans: 0,
      ...
      overdue_action_rate: null,
    },
    currency: {
      overdue_assessments: 0,
      overdue_assessment_rate: null,
