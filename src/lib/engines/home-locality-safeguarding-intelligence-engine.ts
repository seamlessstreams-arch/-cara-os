...
export function computeLocalitySafeguarding(
  ...
  const mitigationEffectiveness = rate(totalEffective, totalMitigations);
  ...
  const reviewCurrencyRate = rate(currentRisks.length, risks.length);
  ...
  const screeningCoverage = rate(screenedChildren.size, total_children);

  // Safety plan rate: pct of screenings with has_safety_plan
  const withSafetyPlan = screenings.filter(s => s.has_safety_plan);
  const safetyPlanRate = rate(withSafetyPlan.length, screenings.length);
  ...
  const managementOversightRate = rate(withOversight.length, screenings.length);
  ...
  const impactAssessmentRate = rate(withImpactAssessment.length, risks.length);
  ...
  if (totalMitigations === 0) {
    ...
    if (meets(mitigationEffectiveness, 90)) score += 6;
    else if (meets(mitigationEffectiveness, 75)) score += 3;
    else if (below(mitigationEffectiveness, 50)) score -= 6;
    else if (below(mitigationEffectiveness, 65)) score -= 3;
  }
  ...
  if (risks.length === 0) {
    ...
    if (meets(reviewCurrencyRate, 90)) score += 5;
    else if (meets(reviewCurrencyRate, 70)) score += 2;
    else if (below(reviewCurrencyRate, 50)) score -= 5;
  }
  ...
  if (screenings.length === 0) {
    ...
    if (meets(screeningCoverage, 90)) score += 5;
    else if (meets(screeningCoverage, 70)) score += 2;
    else if (below(screeningCoverage, 50)) score -= 5;
  }
  ...
  if (screenings.length === 0) {
    ...
    if (meets(safetyPlanRate, 90)) score += 5;
    else if (meets(safetyPlanRate, 70)) score += 2;
    else if (below(safetyPlanRate, 50)) score -= 4;
  }
  ...
  const intelRate = rate(risksWithIntel.length, risks.length);
  if (risks.length === 0) {
    score += 0;
  } else {
    if (meets(intelRate, 90)) score += 5;
    else if (meets(intelRate, 70)) score += 2;
    else if (below(intelRate, 50)) score -= 4;
  }
  ...
  if (missing.length === 0) {
    ...
    const policeRate = rate(missing.filter(m => m.police_notified).length, missing.length);
    const swRate = rate(missing.filter(m => m.social_worker_notified).length, missing.length);
    if (meets(returnInterviewRate, 90) && meets(policeRate, 90) && meets(swRate, 90)) score += 5;
    else if (meets(returnInterviewRate, 70) && meets(policeRate, 70)) score += 2;
    else if (below(returnInterviewRate, 50)) score -= 5;
  }
  ...
  if (totalMitigations > 0 && meets(mitigationEffectiveness, 90)) {
  ...
  } else if (totalMitigations > 0 && meets(mitigationEffectiveness, 75)) {
  ...
  if (risks.length > 0 && meets(reviewCurrencyRate, 90)) {
  ...
  if (totalMitigations > 0 && below(mitigationEffectiveness, 50)) {
  ...
  if (risks.length > 0 && below(reviewCurrencyRate, 50)) {
  ...
  if (screenings.length > 0 && below(screeningCoverage, 50)) {
  ...
  if (screenings.length > 0 && below(safetyPlanRate, 50)) {
  ...
  if (risks.length > 0 && below(intelRate, 50)) {
  ...
  if (returnedMissing.length > 0 && below(returnInterviewRate, 50)) {
  ...
  if (risks.length > 0 && below(impactAssessmentRate, 50)) {
  ...
  if (totalMitigations > 0 && meets(mitigationEffectiveness, 90) && risks.length > 0 && meets(reviewCurrencyRate, 90) && meets(intelRate, 90)) {
  ...
  if (screenings.length > 0 && meets(screeningCoverage, 90) && meets(safetyPlanRate, 90)) {
  ...
  if (missing.length === 0 && total_children > 0 && screenings.length > 0 && meets(screeningCoverage, 70)) {
  ...
  if (screenings.length > 0 && below(managementOversightRate, 50)) {
  ...
  if (rating === "outstanding") {
    headline = `Outstanding locality safeguarding — ${formatRate(mitigationEffectiveness)} mitigation effectiveness, ${formatRate(reviewCurrencyRate)} review currency, ${formatRate(screeningCoverage)} screening coverage.`;
  } else if (rating === "good") {
