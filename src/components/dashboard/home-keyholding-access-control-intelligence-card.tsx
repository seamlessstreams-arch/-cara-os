...
import type { KeyholdingRating, KeyholdingAccessControlResult } from "@/lib/engines/home-keyholding-access-control-intelligence-engine";
...
export function HomeKeyholdingAccessControlIntelligenceCard() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: KeyholdingAccessControlResult }>;
    },
