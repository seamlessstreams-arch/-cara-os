...
const ACTIONS: ActionConfig[] = [
  ...
  },
  {
    ...
    href: (c, _t, s) => `/intelligence/cara/resources?child_id=${c}&source_type=convert&source_id=${s}`,
  },
  {
    ...
    href: (c, _t, s) => `/intelligence/cara/oversight?child_id=${c}&style=social_worker&source_id=${s}`,
  },
  {
    ...
    href: (c, _t, s) => `/intelligence/cara/oversight?child_id=${c}&style=regulation_45&source_id=${s}`,
  },
  {
    ...
    href: (c, _t, s) => `/intelligence/cara/oversight?child_id=${c}&style=reflective&source_id=${s}`,
  },
  {
