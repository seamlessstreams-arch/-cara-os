...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: "Independence intelligence failed" },
      { status: 500 },
    );
  }
}
...
async function fetchData(sb: NonNullable<ReturnType<typeof createServerClient>>, childId: string): Promise<IndependenceInput> {
