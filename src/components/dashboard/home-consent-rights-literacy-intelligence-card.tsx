...
import type { ConsentRightsRating, ConsentRightsResult } from "@/lib/engines/home-consent-rights-literacy-intelligence-engine";
...
export function HomeConsentRightsLiteracyIntelligenceCard() {
  const { data, isLoading } = useQuery<ConsentRightsResponse>({
