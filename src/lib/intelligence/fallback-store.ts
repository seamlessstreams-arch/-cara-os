...
export const reg45Reviews: IntelligenceReg45ReviewRow[] = [
  {
    id: "r1",
    home_id: "home_oak",
    period_start: seedDay(-191),
    period_end: seedDay(-11),
    status: "draft",
    ...
    approved_by: null,
    approved_at: null,
    created_at: seedDay(-10),
    updated_at: seedDay(-8),
  },
  {
    id: "r2",
    home_id: "home_oak",
    period_start: seedDay(-375),
    period_end: seedDay(-192),
    status: "approved",
    quality_of_care_summary:
    ...
    generated_by: "Olivia Hayes",
    approved_by: "Patricia Nolan (RI)",
    approved_at: seedDay(-177),
    created_at: seedDay(-203),
    updated_at: seedDay(-177),
  },
];
...
export const incidentLearningReviews: IntelligenceLearningReviewRow[] = [
  {
    ...
    staff_involved: ["Samuel Boateng", "Daniel Frost"],
    review_status: "required",
    manager_notes: "",
    learning_summary: "",
    trigger_analysis: null,
    created_at: seedDay(-7),
    updated_at: seedDay(-7),
  },
  {
    id: "inc-2",
    home_id: "home_oak",
  ...
  },
  {
    ...
    staff_involved: ["Daniel Frost"],
    review_status: "required",
    manager_notes: "",
    learning_summary: "",
    trigger_analysis: null,
    created_at: seedDay(-10),
    updated_at: seedDay(-10),
  },
  {
    id: "inc-4",
    home_id: "home_oak",
    ...
    staff_involved: ["Samuel Boateng"],
    review_status: "completed",
    manager_notes:
      "Discussed with Samuel. His calm response was excellent. Child struggles with transitions — consider visual timer for homework sessions.",
    learning_summary:
      "Visual timers to be trialled for homework transitions. Staff response was proportionate and effective. No concerns raised.",
    trigger_analysis: null,
    created_at: seedDay(-13),
    updated_at: seedDay(-13),
  },
  {
    id: "inc-5",
    home_id: "home_oak",
    ...
    staff_involved: ["Daniel Frost", "Tom Walker"],
    review_status: "in_progress",
    manager_notes:
      "CAMHS referral made same day. Placement plan updated. Supervision scheduled with Daniel to debrief.",
    learning_summary: "",
    trigger_analysis: null,
    created_at: seedDay(-16),
    updated_at: seedDay(-16),
  },
];
...
export const voiceEntries: IntelligenceVoiceEntryRow[] = [
  ...
  },
  {
    ...
    created_by: "Tom Walker",
    linked_record_id: null,
    linked_record_type: null,
    created_at: seedDay(-9),
  },
  {
    id: "v3",
    home_id: "home_oak",
    child_id: "child-a",
    entry_date: seedDay(-11),
    category: "safety",
    ...
    created_at: seedDay(-11),
  },
  {
    id: "v4",
    home_id: "home_oak",
    child_id: "child-a",
    entry_date: seedDay(-14),
    category: "activity",
    ...
    created_by: "Samuel Boateng",
    linked_record_id: "Activity Plan",
    linked_record_type: "activity_plan",
    created_at: seedDay(-14),
  },
  {
    id: "v5",
    home_id: "home_oak",
    child_id: "child-a",
    entry_date: seedDay(-16),
    category: "complaint",
  ...
  },
  {
    ...
    home_id: "home_oak",
    child_id: "child-a",
    entry_date: seedDay(-19),
    category: "relationship_with_staff",
    child_words: "Samuel is really sound. He does not talk to me like I am a little kid. He actually gets it.",
    summary: "Positive feedback about relationship with staff member Samuel.",
    action_taken: "Shared with Samuel (with consent). Noted in supervision. Highlights importance of age-appropriate communication.",
    staff_response: "Samuel will be pleased to hear that. It is important to us that you feel respected and understood.",
    created_by: "Daniel Frost",
    linked_record_id: null,
    linked_record_type: null,
    created_at: seedDay(-19),
  },
  {
    id: "v7",
    home_id: "home_oak",
    child_id: "child-a",
    entry_date: seedDay(-22),
    category: "bedroom",
    ...
    linked_record_id: null,
    linked_record_type: null,
    created_at: seedDay(-22),
  },
  {
    id: "v8",
    home_id: "home_oak",
    child_id: "child-a",
    entry_date: seedDay(-25),
    category: "education",
    ...
    created_at: seedDay(-25),
  },
  {
    id: "v9",
    home_id: "home_oak",
    child_id: "child-a",
    entry_date: seedDay(-29),
    ...
    linked_record_id: null,
    linked_record_type: null,
    created_at: seedDay(-29),
  },
  {
    id: "v10",
    home_id: "home_oak",
    child_id: "child-a",
    entry_date: seedDay(-33),
...
export const progressGoals: IntelligenceProgressGoalRow[] = [
  ...
  },
  {
    ...
    status: "not_started",
    target_date: seedDay(80),
    description:
      "Wake up, shower, dress, breakfast, pack bag without staff prompts. Currently requires 2-3 prompts each morning.",
    progress: 15,
    created_at: seedDay(-71),
  },
];

export const progressEntries: IntelligenceProgressEntryRow[] = [
  { id: "p1", home_id: "home_oak", child_id: "child-a", entry_date: seedDay(-7), area: "education", what_happened: "Completed English mock exam independently. Showed real focus and determination throughout the paper.", impact_on_child: "Predicted grade moved from 4 to 5. Teacher noted significant improvement in essay structure.", staff_member: "Daniel Frost", created_at: seedDay(-7) },
  { id: "p2", home_id: "home_oak", child_id: "child-a", entry_date: seedDay(-9), area: "emotional_wellbeing", what_happened: "Used breathing techniques when frustrated with homework. Chose to go to quiet room rather than escalate.", impact_on_child: "First time choosing de-escalation independently without staff prompt. Major milestone.", staff_member: "Samuel Boateng", created_at: seedDay(-9) },
  { id: "p3", home_id: "home_oak", child_id: "child-a", entry_date: seedDay(-13), area: "relationships", what_happened: "Video called grandmother. Talked for 35 minutes about school and upcoming birthday plans.", impact_on_child: "Grandmother reported feeling much closer. Child asked if she could visit during half term.", staff_member: "Daniel Frost", created_at: seedDay(-13) },
  { id: "p4", home_id: "home_oak", child_id: "child-a", entry_date: seedDay(-16), area: "independence", what_happened: "Made own breakfast for the first time without being asked. Set alarm and got up 10 minutes early.", impact_on_child: "Small but significant step. Staff praised effort without overdoing it. Child seemed proud.", staff_member: "Tom Walker", created_at: seedDay(-16) },
  { id: "p5", home_id: "home_oak", child_id: "child-a", entry_date: seedDay(-19), area: "health", what_happened: "Attended dental appointment without anxiety. Previously refused all medical appointments.", impact_on_child: "Dentist gave positive feedback. No treatment needed. Agreed to 6-month check-up.", staff_member: "Samuel Boateng", created_at: seedDay(-19) },
  { id: "p6", home_id: "home_oak", child_id: "child-a", entry_date: seedDay(-23), area: "community", what_happened: "Joined local football club training session. Engaged well with peers and followed coach instructions.", impact_on_child: "Coach invited back next week. First sustained community activity in 8 months.", staff_member: "Tom Walker", created_at: seedDay(-23) },
  { id: "p7", home_id: "home_oak", child_id: "child-a", entry_date: seedDay(-26), area: "behaviour_support", what_happened: "Apologised unprompted to another young person after disagreement over TV remote.", impact_on_child: "Relationship repair happened naturally. Other YP accepted apology. No staff mediation needed.", staff_member: "Daniel Frost", created_at: seedDay(-26) },
  { id: "p8", home_id: "home_oak", child_id: "child-a", entry_date: seedDay(-31), area: "wishes_and_feelings", what_happened: "Shared in key work session that they would like to try cooking a meal for the house.", impact_on_child: "Activity scheduled for next week. Links to independence goal and building confidence.", staff_member: "Daniel Frost", created_at: seedDay(-31) },
];
...
export const evidenceItems: IntelligenceEvidenceItemRow[] = [
  { id: "ev_01", home_id: "h1", child_id: "c1", staff_id: null, source_record_type: "key_work", source_record_id: "kw_221", title: "Jordan expresses feeling settled and safe", description: "In key work session, Jordan shared that he feels safe at the home and has positive relationships with staff. He identified two staff members he would approach if worried.", category: "wishes_and_feelings", judgement_area: "overall_experiences_and_progress", quality_indicator: 92, evidence_date: _dRel(-3), created_by: "Daniel Frost", created_at: _dRel(-3) },
  { id: "ev_02", home_id: "h1", child_id: "c2", staff_id: null, source_record_type: "incident", source_record_id: "inc_145", title: "Casey supported through emotional crisis with de-escalation", description: "Staff used TCI de-escalation techniques when Casey became distressed. Physical intervention was avoided. Casey was offered a debrief and engaged well. Manager oversight completed within 24 hours.", category: "behaviour_support", judgement_area: "help_and_protection", quality_indicator: 88, evidence_date: _dRel(-5), created_by: "Olivia Hayes", created_at: _dRel(-5) },
  { id: "ev_03", home_id: "h1", child_id: null, staff_id: null, source_record_type: "supervision", source_record_id: "sup_098", title: "Staff supervision cycle completed on time", description: "All staff supervisions completed within the 6-week cycle. Reflective practice was evident in each record, with clear action points and follow-up from previous sessions.", category: "staff_supervision", judgement_area: "effectiveness_of_leaders", quality_indicator: 95, evidence_date: _dRel(-7), created_by: "Olivia Hayes", created_at: _dRel(-7) },
  { id: "ev_04", home_id: "h1", child_id: "c3", staff_id: null, source_record_type: "daily_log", source_record_id: "dl_1892", title: "Reece attends first full week of school", description: "Reece completed a full week of school attendance for the first time since placement. Staff provided consistent morning routines and positive reinforcement. School feedback was excellent.", category: "education", judgement_area: "overall_experiences_and_progress", quality_indicator: 90, evidence_date: _dRel(-10), created_by: "Samuel Boateng", created_at: _dRel(-10) },
  { id: "ev_05", home_id: "h1", child_id: "c1", staff_id: null, source_record_type: "risk_assessment", source_record_id: "ra_034", title: "Jordan's risk assessment reviewed following community incident", description: "Risk assessment updated promptly after Jordan was involved in a community incident. New control measures added, and Jordan was involved in reviewing the document. Social worker informed.", category: "risk_assessment", judgement_area: "help_and_protection", quality_indicator: 85, evidence_date: _dRel(-12), created_by: "Olivia Hayes", created_at: _dRel(-12) },
  { id: "ev_06", home_id: "h1", child_id: null, staff_id: null, source_record_type: "reg44_report", source_record_id: "r44_012", title: "Regulation 44 visit completed with positive findings", description: "Independent visitor completed quarterly visit. All children spoken to, records reviewed, environment inspected. Two recommendations made, both acknowledged and actioned by Registered Manager.", category: "regulation_44", judgement_area: "effectiveness_of_leaders", quality_indicator: 96, evidence_date: _dRel(-14), created_by: "Olivia Hayes", created_at: _dRel(-14) },
  { id: "ev_07", home_id: "h1", child_id: "c2", staff_id: null, source_record_type: "child_voice", source_record_id: "cv_067", title: "Casey contributes ideas for house improvements", description: "During house meeting, Casey suggested changes to the communal lounge layout and new activity ideas. Suggestions were recorded and two were implemented within the week.", category: "wishes_and_feelings", judgement_area: "overall_experiences_and_progress", quality_indicator: 80, evidence_date: _dRel(-16), created_by: "Daniel Frost", created_at: _dRel(-16) },
  { id: "ev_08", home_id: "h1", child_id: null, staff_id: null, source_record_type: "training_record", source_record_id: "tr_088", title: "Team completes refresher safeguarding training", description: "All permanent staff completed Level 3 safeguarding refresher within required timeframe. Agency staff completed induction-level safeguarding before shifts. Training matrix updated.", category: "safeguarding", judgement_area: "help_and_protection", quality_indicator: 94, evidence_date: _dRel(-18), created_by: "Olivia Hayes", created_at: _dRel(-18) },
...
export const staffPassportRecords: IntelligenceStaffPassportRecord[] = [
  { id: "staff-a", name: "Staff A - Sarah Mitchell", role: "Senior Residential Worker", startDate: seedDay(-1518),
    passport: [
      { label: "DBS Status", status: "valid", detail: "Enhanced DBS - Update service registered", expiryDate: seedDay(308) },
      ...
      { label: "Safeguarding Training", status: "valid", detail: "Level 3 - Refreshed Jan 2026", expiryDate: seedDay(614) },
      { label: "Medication Competency", status: "valid", detail: "Assessed and signed off by manager", expiryDate: seedDay(193) },
      { label: "Physical Intervention", status: "valid", detail: "Team Teach Level 2 - refreshed Feb 2026", expiryDate: seedDay(275) },
    ...
    competencyFlags: [
      { label: "Can Lead Shift", granted: true, grantedDate: seedDay(-1075) },
      { label: "Can Administer Medication", granted: true, grantedDate: seedDay(-1334) },
      { label: "Can Lone Work", granted: true, grantedDate: seedDay(-1217) },
      { label: "Can Supervise Others", granted: true, grantedDate: seedDay(-801) },
    ],
    warnings: [], restrictions: [],
    compliments: [
      { id: "c1", text: "Brilliant handling of a difficult situation with Child A. Calm, professional, and child-centred throughout.", from: "Olivia Hayes (RM)", date: seedDay(-21) },
      { id: "c2", text: "Thank you for covering extra shifts this month without complaint. Really valued.", from: "Olivia Hayes (RM)", date: seedDay(-36) },
    ],
  },
  { id: "staff-b", name: "Staff B - James Cooper", role: "Residential Worker", startDate: seedDay(-983),
    passport: [
      { label: "DBS Status", status: "valid", detail: "Enhanced DBS", expiryDate: seedDay(113) },
      { label: "References", status: "valid", detail: "2 satisfactory references on file" },
      ...
      { label: "Mandatory Training", status: "expiring", detail: "10 of 12 modules current. 2 due renewal", expiryDate: seedDay(21) },
      { label: "Safeguarding Training", status: "valid", detail: "Level 2 - completed Oct 2025", expiryDate: seedDay(522) },
      { label: "Medication Competency", status: "valid", detail: "Assessed by senior", expiryDate: seedDay(204) },
      { label: "Physical Intervention", status: "valid", detail: "Team Teach Level 1", expiryDate: seedDay(254) },
    ...
    competencyFlags: [
      ...
      { label: "Can Administer Medication", granted: true, grantedDate: seedDay(-709) },
      { label: "Can Lone Work", granted: false },
      { label: "Can Supervise Others", granted: false },
    ],
    warnings: [
      { id: "w1", severity: "medium", title: "Supervision overdue", description: "Last supervision was 20 days ago. Monthly supervision required per Reg 33.", date: seedDay(-6) },
      { id: "w2", severity: "low", title: "2 training modules expiring", description: "Fire Safety and First Aid modules expire on 1 June 2026.", date: seedDay(-10) },
    ],
    restrictions: [],
    compliments: [
      { id: "c1", text: "Great relationship building with Child C. They really respond well to you.", from: "Sarah Mitchell (Senior)", date: seedDay(-57) },
    ],
  },
  { id: "staff-c", name: "Staff C - Tom Richards", role: "Residential Worker", startDate: seedDay(-709),
    passport: [
      { label: "DBS Status", status: "valid", detail: "Enhanced DBS", expiryDate: seedDay(386) },
      ...
      { label: "Safeguarding Training", status: "valid", detail: "Level 2", expiryDate: seedDay(416) },
      { label: "Medication Competency", status: "not_started", detail: "Assessment booked for June 2026" },
      { label: "Physical Intervention", status: "valid", detail: "Team Teach Level 1", expiryDate: seedDay(294) },
    ...
    warnings: [
      { id: "w1", severity: "low", title: "Medication competency not yet assessed", description: "Cannot administer medication until assessment completed.", date: seedDay(-10) },
    ],
    restrictions: [
      { id: "r1", restriction: "Cannot administer medication", reason: "Competency assessment not yet completed", appliedDate: seedDay(-709), appliedBy: "Olivia Hayes" },
    ],
    compliments: [],
  },
  { id: "staff-d", name: "Staff D - Priya Patel", role: "Waking Night Worker", startDate: seedDay(-1217),
    passport: [
      { label: "DBS Status", status: "valid", detail: "Enhanced DBS", expiryDate: seedDay(-121) },
      { label: "References", status: "valid", detail: "2 satisfactory references" },
      { label: "Right to Work", status: "valid", detail: "British Citizen" },
      ...
      { label: "Mandatory Training", status: "expired", detail: "3 modules expired in April 2026", expiryDate: seedDay(-40) },
      { label: "Safeguarding Training", status: "valid", detail: "Level 2", expiryDate: seedDay(266) },
      { label: "Medication Competency", status: "valid", detail: "Night meds only", expiryDate: seedDay(82) },
      { label: "Physical Intervention", status: "expired", detail: "Team Teach expired March 2026", expiryDate: seedDay(-71) },
    ...
    competencyFlags: [
      { label: "Can Lead Shift", granted: false },
      { label: "Can Administer Medication", granted: true, grantedDate: seedDay(-1014) },
      { label: "Can Lone Work", granted: true, grantedDate: seedDay(-969) },
      { label: "Can Supervise Others", granted: false },
    ],
    warnings: [
      { id: "w1", severity: "high", title: "Physical intervention training expired", description: "Team Teach certification expired March 2026. Cannot be involved in any physical interventions.", date: seedDay(-40) },
      { id: "w2", severity: "high", title: "Supervision severely overdue", description: "9 weeks since last supervision. Reg 33 requires monthly. Immediate action needed.", date: seedDay(-6) },
      { id: "w3", severity: "medium", title: "3 mandatory training modules expired", description: "Lone Working, Equality & Diversity, and Data Protection all expired.", date: seedDay(-26) },
    ],
    restrictions: [
      { id: "r1", restriction: "Cannot use physical intervention", reason: "Team Teach certification expired", appliedDate: seedDay(-40), appliedBy: "Olivia Hayes" },
    ],
    compliments: [
      { id: "c1", text: "Priya is always calm and reassuring during night shifts. The children feel safe with her.", from: "Olivia Hayes (RM)", date: seedDay(-80) },
    ],
  },
  { id: "staff-e", name: "Staff E - Marcus Williams", role: "Senior Residential Worker", startDate: seedDay(-1652),
    passport: [
      { label: "DBS Status", status: "valid", detail: "Enhanced DBS - Update service", expiryDate: seedDay(539) },
      { label: "References", status: "valid", detail: "2 satisfactory references" },
      { label: "Right to Work", status: "valid", detail: "British Citizen" },
      ...
      { label: "Safeguarding Training", status: "valid", detail: "Level 3", expiryDate: seedDay(478) },
      { label: "Medication Competency", status: "valid", detail: "Full competency", expiryDate: seedDay(249) },
      { label: "Physical Intervention", status: "valid", detail: "Team Teach Level 2 - Trainer", expiryDate: seedDay(386) },
      { label: "Last Supervision", status: "valid", detail: "30 Apr 2026" },
      { label: "Last Appraisal", status: "valid", detail: "Completed Nov 2025" },
    ],
    competencyFlags: [
      { label: "Can Lead Shift", granted: true, grantedDate: seedDay(-1471) },
      { label: "Can Administer Medication", granted: true, grantedDate: seedDay(-1532) },
      { label: "Can Lone Work", granted: true, grantedDate: seedDay(-1426) },
      { label: "Can Supervise Others", granted: true, grantedDate: seedDay(-922) },
    ],
    warnings: [], restrictions: [],
    compliments: [
      { id: "c1", text: "Marcus is an outstanding practitioner. His approach with the most challenging children is exemplary.", from: "Ofsted Inspector", date: seedDay(-182) },
      { id: "c2", text: "Thank you for mentoring the new staff so effectively. They all speak highly of your support.", from: "Olivia Hayes (RM)", date: seedDay(-71) },
      { id: "c3", text: "Marcus handled the crisis brilliantly. Professional, proportionate and child-focused throughout.", from: "RI - Regional Manager", date: seedDay(-116) },
    ],
  },
  { id: "staff-f", name: "Staff F - Amy Green", role: "Residential Worker (New Starter)", startDate: seedDay(-27),
    passport: [
    ...
    warnings: [],
    restrictions: [
      { id: "r1", restriction: "Cannot lone work", reason: "Induction period - must be supernumerary", appliedDate: seedDay(-27), appliedBy: "Olivia Hayes" },
      { id: "r2", restriction: "Cannot administer medication", reason: "Not yet assessed", appliedDate: seedDay(-27), appliedBy: "Olivia Hayes" },
      { id: "r3", restriction: "Cannot use physical intervention", reason: "Training not yet completed", appliedDate: seedDay(-27), appliedBy: "Olivia Hayes" },
    ],
    compliments: [],
  },
];
...
export const providerHomeSummaries: IntelligenceProviderHomeSummary[] = [
  ...
  },
  {
    ...
    missingEpisodes: 0,
    caraRiskFlags: [],
    lastReviewed: seedDay(-8),
  },
];

export const providerOversightLog: IntelligenceProviderOversightEntry[] = [
  { id: "ol-1", date: seedDay(-8), home: "Willow Place", type: "review", content: "Monthly quality review completed. All areas meeting or exceeding standards. Commend David and team for consistent excellence.", author: "Regional Inspector", status: "closed" },
  { id: "ol-2", date: seedDay(-10), home: "Chamberlain House", type: "comment", content: "Noted improvement in recording quality following last visit. Progress entries are now timely and outcome-focused. One night staff supervision gap to address.", author: "Regional Inspector", status: "open" },
  { id: "ol-3", date: seedDay(-13), home: "Birch Lodge", type: "action_request", content: "Reg 44 visit now 12 days overdue. Manager to complete within 48 hours and submit report. Supervision compliance plan required by 5 May.", author: "Regional Inspector", status: "open" },
  { id: "ol-4", date: seedDay(-16), home: "Birch Lodge", type: "escalation", content: "Pattern of missing episodes identified - 4 in 30 days involving 2 different young people. Requesting immediate review of risk assessments and boundary agreements.", author: "Regional Inspector", status: "open" },
  { id: "ol-5", date: seedDay(-21), home: "Chamberlain House", type: "review", content: "Unannounced visit completed. Children appeared settled and engaged. Staff interactions observed as warm and appropriate. Minor recommendation around medication storage labelling.", author: "Regional Inspector", status: "closed" },
];
...
export const caraSuggestions: CaraSuggestionRow[] = [
  _caraBase({
    ...
    draft_text: _draft1,
    created_at: `${seedDay(-6)}T08:15:00Z`,
    linked_records: [
...
export const hrCases: HrCaseSummaryRow[] = [
  { id: "hrc_001", staffName: "Staff Member A", caseType: "safeguarding_allegation", riskLevel: "black", status: "investigation", safeguardingStatus: "lado_consulted", openedAt: seedDay(-13), daysSinceOpened: 7, lastActionAt: seedDay(-7), caseOwner: "Registered Manager", riOversightRequired: true, riOversightCompleted: false, overdueTaskCount: 1 },
  { id: "hrc_002", staffName: "Staff Member B", caseType: "disciplinary", riskLevel: "red", status: "meeting_scheduled", safeguardingStatus: "not_safeguarding", openedAt: seedDay(-26), daysSinceOpened: 20, lastActionAt: seedDay(-9), caseOwner: "Registered Manager", riOversightRequired: false, riOversightCompleted: false, overdueTaskCount: 0 },
  { id: "hrc_003", staffName: "Staff Member C", caseType: "sickness_absence", riskLevel: "amber", status: "open", safeguardingStatus: "not_safeguarding", openedAt: seedDay(-52), daysSinceOpened: 46, lastActionAt: seedDay(-13), caseOwner: "Deputy Manager", riOversightRequired: false, riOversightCompleted: false, overdueTaskCount: 2 },
  { id: "hrc_004", staffName: "Staff Member D", caseType: "suspension", riskLevel: "red", status: "suspended", safeguardingStatus: "safeguarding_open", openedAt: seedDay(-19), daysSinceOpened: 13, lastActionAt: seedDay(-10), caseOwner: "Registered Manager", riOversightRequired: true, riOversightCompleted: true, overdueTaskCount: 0 },
  { id: "hrc_005", staffName: "Staff Member E", caseType: "probation", riskLevel: "green", status: "open", safeguardingStatus: "not_safeguarding", openedAt: seedDay(-90), daysSinceOpened: 84, lastActionAt: seedDay(-11), caseOwner: "Deputy Manager", riOversightRequired: false, riOversightCompleted: false, overdueTaskCount: 0 },
  { id: "hrc_006", staffName: "Staff Member F", caseType: "grievance", riskLevel: "amber", status: "outcome_pending", safeguardingStatus: "not_safeguarding", openedAt: seedDay(-40), daysSinceOpened: 34, lastActionAt: seedDay(-16), caseOwner: "Registered Manager", riOversightRequired: false, riOversightCompleted: false, overdueTaskCount: 1 },
];

export const hrOverdueTasks: HrTaskSummaryRow[] = [
  { id: "hrt_001", title: "Schedule LADO strategy discussion", linkedCaseId: "hrc_001", assignedTo: "Registered Manager", dueDate: seedDay(-8), daysOverdue: 2, priority: "urgent" },
  { id: "hrt_002", title: "Send return-to-work meeting invite", linkedCaseId: "hrc_003", assignedTo: "Deputy Manager", dueDate: seedDay(-10), daysOverdue: 4, priority: "high" },
  { id: "hrt_003", title: "Chase occupational health referral", linkedCaseId: "hrc_003", assignedTo: "Deputy Manager", dueDate: seedDay(-13), daysOverdue: 7, priority: "medium" },
  { id: "hrt_004", title: "Outcome letter to be drafted", linkedCaseId: "hrc_006", assignedTo: "Registered Manager", dueDate: seedDay(-9), daysOverdue: 3, priority: "high" },
];
...
export const hrInspectionRecruitment: Array<Record<string, unknown>> = [
  { staffRef: "Staff Member G", startDate: seedDay(-40), dbsCleared: true, dbsDate: seedDay(-52), referencesReceived: true, referenceCount: 2, rightToWork: true, qualificationsVerified: true, healthDeclaration: true, safeguardingTraining: true, gateOutcome: "approved", outstandingItems: [] },
  { staffRef: "Staff Member H", startDate: seedDay(-26), dbsCleared: true, dbsDate: seedDay(-31), referencesReceived: false, referenceCount: 1, rightToWork: true, qualificationsVerified: true, healthDeclaration: true, safeguardingTraining: false, gateOutcome: "blocked", outstandingItems: ["Second reference", "Safeguarding training"] },
  { staffRef: "Staff Member I", startDate: seedDay(-62), dbsCleared: true, dbsDate: seedDay(-67), referencesReceived: true, referenceCount: 2, rightToWork: true, qualificationsVerified: false, healthDeclaration: true, safeguardingTraining: true, gateOutcome: "senior_risk_acceptance", outstandingItems: ["Qualification certificate — RI risk accepted pending verification"] },
];

export const hrInspectionCases: Array<Record<string, unknown>> = [
  { id: "hrc_001", staffRef: "Staff Member A", caseType: "safeguarding_allegation", riskLevel: "black", status: "investigation", safeguardingStatus: "lado_consulted", openedAt: seedDay(-13), daysDuration: 7, actionCount: 8, lettersIssued: 2, guardianReviews: 2, riOversightRequired: true, riOversightCompleted: false },
  { id: "hrc_002", staffRef: "Staff Member B", caseType: "disciplinary", riskLevel: "red", status: "meeting_scheduled", safeguardingStatus: "not_safeguarding", openedAt: seedDay(-26), daysDuration: 20, actionCount: 5, lettersIssued: 1, guardianReviews: 1, riOversightRequired: false, riOversightCompleted: false },
  { id: "hrc_003", staffRef: "Staff Member C", caseType: "sickness_absence", riskLevel: "amber", status: "open", safeguardingStatus: "not_safeguarding", openedAt: seedDay(-52), daysDuration: 46, actionCount: 3, lettersIssued: 1, guardianReviews: 0, riOversightRequired: false, riOversightCompleted: false },
  { id: "hrc_004", staffRef: "Staff Member D", caseType: "suspension", riskLevel: "red", status: "suspended", safeguardingStatus: "safeguarding_open", openedAt: seedDay(-19), daysDuration: 13, actionCount: 6, lettersIssued: 1, guardianReviews: 1, riOversightRequired: true, riOversightCompleted: true },
  { id: "hrc_006", staffRef: "Staff Member F", caseType: "grievance", riskLevel: "amber", status: "outcome_pending", safeguardingStatus: "not_safeguarding", openedAt: seedDay(-40), daysDuration: 34, actionCount: 7, lettersIssued: 2, guardianReviews: 1, riOversightRequired: false, riOversightCompleted: false },
  { id: "hrc_closed_001", staffRef: "Staff Member J", caseType: "conduct", riskLevel: "green", status: "closed", safeguardingStatus: "not_safeguarding", openedAt: seedDay(-121), closedAt: seedDay(-67), daysDuration: 54, actionCount: 9, lettersIssued: 3, guardianReviews: 2, riOversightRequired: false, riOversightCompleted: false, outcome: "Written warning issued" },
];

export const hrInspectionChronology: Array<Record<string, unknown>> = [
  { date: seedDay(-13), caseRef: "hrc_001", staffRef: "Staff Member A", event: "Safeguarding allegation received — child disclosed concern to key worker", significance: "critical" },
  { date: seedDay(-13), caseRef: "hrc_001", staffRef: "Staff Member A", event: "LADO consultation initiated within 1 hour of disclosure", significance: "critical" },
  { date: seedDay(-13), caseRef: "hrc_001", staffRef: "Staff Member A", event: "Staff member informed of allegation and precautionary measures", significance: "significant" },
  { date: seedDay(-19), caseRef: "hrc_004", staffRef: "Staff Member D", event: "Suspension decision taken — five risk factors assessed, alternatives considered and recorded", significance: "critical" },
  { date: seedDay(-19), caseRef: "hrc_004", staffRef: "Staff Member D", event: "Welfare plan established for suspended staff member", significance: "significant" },
  { date: seedDay(-26), caseRef: "hrc_002", staffRef: "Staff Member B", event: "Disciplinary concern raised following pattern of recording failures", significance: "significant" },
  { date: seedDay(-26), caseRef: "hrc_002", staffRef: "Staff Member B", event: "Investigation commenced — terms of reference drafted and shared", significance: "significant" },
  { date: seedDay(-40), caseRef: "hrc_006", staffRef: "Staff Member F", event: "Formal grievance submitted in writing", significance: "significant" },
  { date: seedDay(-52), caseRef: "hrc_003", staffRef: "Staff Member C", event: "Sickness absence exceeds trigger point (10 days rolling)", significance: "routine" },
  { date: seedDay(-67), caseRef: "hrc_closed_001", staffRef: "Staff Member J", event: "Conduct case closed — written warning issued following investigation", significance: "significant" },
];

export const hrInspectionSuspensions: Array<Record<string, unknown>> = [
  { staffRef: "Staff Member D", startDate: seedDay(-19), daysActive: 13, reason: "Safeguarding allegation — precautionary pending investigation", riskFactorsConsidered: true, alternativesConsidered: true, welfarePlanInPlace: true, reviewsDue: 2, reviewsCompleted: 1, ladoLinked: true, resolved: false },
  { staffRef: "Staff Member K", startDate: seedDay(-90), endDate: seedDay(-57), daysActive: 33, reason: "Serious conduct allegation", riskFactorsConsidered: true, alternativesConsidered: true, welfarePlanInPlace: true, reviewsDue: 3, reviewsCompleted: 3, ladoLinked: false, resolved: true, resolutionOutcome: "Returned to work with support plan" },
];

export const hrInspectionLado: Array<Record<string, unknown>> = [
  { staffRef: "Staff Member A", referralDate: seedDay(-13), allegationCategory: "Behaviour that may have harmed a child", status: "open", dbsReferralMade: false, ofstedNotified: true },
  { staffRef: "Staff Member L", referralDate: seedDay(-116), allegationCategory: "Conduct towards a child", ladoOutcome: "Unsubstantiated", status: "closed", dbsReferralMade: false, ofstedNotified: true, daysToResolution: 42 },
];

export const hrInspectionCompliance: Array<Record<string, unknown>> = [
  { staffRef: "Staff Member A", dbsStatus: "current", dbsUpdateServiceRegistered: true, mandatoryTrainingComplete: true, mandatoryTrainingGaps: [], lastSupervisionDate: seedDay(-21), supervisionOverdueDays: 0, lastAppraisalDate: seedDay(-177), appraisalOverdueDays: 0 },
  { staffRef: "Staff Member B", dbsStatus: "current", dbsUpdateServiceRegistered: false, mandatoryTrainingComplete: true, mandatoryTrainingGaps: [], lastSupervisionDate: seedDay(-23), supervisionOverdueDays: 0, lastAppraisalDate: seedDay(-203), appraisalOverdueDays: 0 },
  { staffRef: "Staff Member C", dbsStatus: "current", dbsUpdateServiceRegistered: true, mandatoryTrainingComplete: false, mandatoryTrainingGaps: ["First aid refresher"], lastSupervisionDate: seedDay(-62), supervisionOverdueDays: 12, lastAppraisalDate: seedDay(-238), appraisalOverdueDays: 0 },
  { staffRef: "Staff Member D", dbsStatus: "current", dbsUpdateServiceRegistered: true, mandatoryTrainingComplete: true, mandatoryTrainingGaps: [], lastSupervisionDate: seedDay(-31), supervisionOverdueDays: 0, lastAppraisalDate: seedDay(-283), appraisalOverdueDays: 90 },
  { staffRef: "Staff Member E", dbsStatus: "due_renewal", dbsUpdateServiceRegistered: false, mandatoryTrainingComplete: true, mandatoryTrainingGaps: [], lastSupervisionDate: seedDay(-16), supervisionOverdueDays: 0, lastAppraisalDate: seedDay(-121), appraisalOverdueDays: 0 },
  { staffRef: "Staff Member F", dbsStatus: "current", dbsUpdateServiceRegistered: true, mandatoryTrainingComplete: false, mandatoryTrainingGaps: ["Safeguarding refresher", "Medication administration"], lastSupervisionDate: seedDay(-80), supervisionOverdueDays: 30, lastAppraisalDate: seedDay(-157), appraisalOverdueDays: 0 },
];

export const hrInspectionOversight: Array<Record<string, unknown>> = [
  { caseRef: "hrc_004", staffRef: "Staff Member D", oversightType: "ri_review", completedBy: "Responsible Individual", completedAt: seedDay(-16), findingSummary: "Suspension decision proportionate. Welfare plan in place. LADO consultation timely.", actionsRequired: 1, actionsCompleted: 1 },
  { caseRef: "hrc_closed_001", staffRef: "Staff Member J", oversightType: "rm_quality_check", completedBy: "Registered Manager", completedAt: seedDay(-66), findingSummary: "Investigation thorough. Outcome proportionate. Learning actions identified and logged.", actionsRequired: 2, actionsCompleted: 2 },
  { caseRef: "hrc_001", staffRef: "Staff Member A", oversightType: "ri_review", completedBy: "Responsible Individual", completedAt: seedDay(-11), findingSummary: "LADO referral timely. Ofsted notified. Investigation in progress — next review 5 May.", actionsRequired: 2, actionsCompleted: 1 },
];
