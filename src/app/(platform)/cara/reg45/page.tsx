...
const DEMO_EVIDENCE: Regulation45EvidenceItem[] = [
  {
    ...
    source_table: "daily_log_entries", source_record_id: "dl-101", source_date: seedDay(-33),
    quality_score: 85, is_child_voice: true, is_safeguarding: false, is_risk_related: false,
    agent_run_id: null, reviewed_by: "Sarah Thompson", reviewed_at: `${seedDay(-32)}T10:00:00Z`,
    status: "accepted", created_at: `${seedDay(-33)}T18:00:00Z`,
  },
  {
    ...
    source_table: "missing_episodes", source_record_id: "me-201", source_date: seedDay(-36),
    quality_score: 92, is_child_voice: true, is_safeguarding: true, is_risk_related: true,
    agent_run_id: null, reviewed_by: "Sarah Thompson", reviewed_at: `${seedDay(-35)}T09:00:00Z`,
    status: "accepted", created_at: `${seedDay(-36)}T22:00:00Z`,
  },
  {
    ...
    source_table: "generic_records", source_record_id: "gr-301", source_date: seedDay(-38),
    ...
    status: "suggested", created_at: `${seedDay(-38)}T15:00:00Z`,
  },
  {
    ...
    source_table: "generic_records", source_record_id: "gr-401", source_date: seedDay(-29),
    quality_score: 90, is_child_voice: false, is_safeguarding: false, is_risk_related: false,
    agent_run_id: null, reviewed_by: "Sarah Thompson", reviewed_at: `${seedDay(-29)}T16:00:00Z`,
    status: "included_in_report", created_at: `${seedDay(-29)}T14:00:00Z`,
  },
  {
    ...
    source_table: "generic_records", source_record_id: "gr-501", source_date: seedDay(-31),
    quality_score: 70, is_child_voice: false, is_safeguarding: false, is_risk_related: false,
    agent_run_id: null, reviewed_by: null, reviewed_at: null,
    status: "suggested", created_at: `${seedDay(-31)}T12:00:00Z`,
  },
  {
    ...
    source_table: "daily_log_entries", source_record_id: "dl-601", source_date: seedDay(-30),
    quality_score: 88, is_child_voice: true, is_safeguarding: false, is_risk_related: false,
    agent_run_id: null, reviewed_by: "Sarah Thompson", reviewed_at: `${seedDay(-30)}T17:00:00Z`,
    status: "accepted", created_at: `${seedDay(-30)}T16:00:00Z`,
  },
  {
    ...
    source_table: "incidents", source_record_id: "inc-701", source_date: seedDay(-32),
    quality_score: 82, is_child_voice: false, is_safeguarding: true, is_risk_related: true,
    agent_run_id: null, reviewed_by: "Sarah Thompson", reviewed_at: `${seedDay(-31)}T10:00:00Z`,
    status: "accepted", created_at: `${seedDay(-32)}T20:00:00Z`,
  },
  {
    ...
    source_table: "documents", source_record_id: "doc-801", source_date: seedDay(-34),
    quality_score: 75, is_child_voice: false, is_safeguarding: false, is_risk_related: false,
    agent_run_id: null, reviewed_by: null, reviewed_at: null,
    status: "suggested", created_at: `${seedDay(-34)}T14:00:00Z`,
  },
];
