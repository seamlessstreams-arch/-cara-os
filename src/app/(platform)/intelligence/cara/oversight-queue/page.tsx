...
import type { ManagerOversightItem, ManagerOversightQueue, CaraCommittedRecord } from "@/types/cara-studio";

// ── Data hooks (inlined from the former use-management-oversight wrapper) ─────
...
function useManagementOversight(homeId: string) {
  return useQuery({
...
function useAcknowledgeAmendment() {
