...
import type { CulturalEventsRating, CulturalEventsResult } from "@/lib/engines/home-cultural-events-celebrations-intelligence-engine";
...
export function HomeCulturalEventsCelebrationsIntelligenceCard() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: CulturalEventsResult }>;
    },
