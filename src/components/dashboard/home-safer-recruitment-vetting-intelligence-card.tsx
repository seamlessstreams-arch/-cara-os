...
import type { SaferRecruitmentResult, SaferRecruitmentRating } from "@/lib/engines/home-safer-recruitment-vetting-intelligence-engine";
...
export function HomeSaferRecruitmentVettingIntelligenceCard() {
  const { data, isLoading } = useQuery<SaferRecruitmentResponse>({
