...
import type { OutdoorNatureRating, OutdoorNatureResult } from "@/lib/engines/home-outdoor-nature-engagement-intelligence-engine";

function useHomeOutdoorNatureEngagementIntelligence() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return res.json() as Promise<{ data: OutdoorNatureResult }>;
    },
