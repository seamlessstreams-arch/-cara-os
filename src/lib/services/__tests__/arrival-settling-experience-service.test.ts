...
function makeRecord(overrides?: Partial<ArrivalSettlingExperienceRecord>): ArrivalSettlingExperienceRecord {
  return {
    ...
    arrival_stage: "first_day_welcome",
    settling_quality: "settled_well",
    welcome_assessment: "good",
    ...
    room_prepared: true,
    personal_items_respected: true,
    child_preferences_asked: true,
    tour_provided: true,
    peer_introductions_made: true,
    key_worker_assigned: true,
    care_plan_reflects: true,
    social_worker_informed: true,
    parent_informed: true,
    emergency_contacts_confirmed: true,
    dietary_needs_checked: true,
