// ══════════════════════════════════════════════════════════════════════════════
// API: /api/aria/missing-episodes — Missing Episodes Intelligence
//
...
import { analyseMissingEpisodes } from "@/lib/aria/missing-episodes-intelligence";
import { createServerClient, isSupabaseEnabled } from "@/lib/supabase/server";
import type { MissingInput, MissingEpisode } from "@/lib/aria/missing-episodes-intelligence";
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[aria/missing-episodes] Error:", err);
    return NextResponse.json(
