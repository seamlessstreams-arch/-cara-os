...
intelligenceStore.childExperience = [
  ...
  // Alex — week 1
  {
    ...
    evidence_refs: [
      ...
      { type: "daily_log", id: "log_mar_003", date: "2026-04-04", excerpt: "Accepted hot chocolate from Samuel at 22:30 — first positive contact", significance: "early trust indicator" },
    ],
    computed_by: "cara",
    reviewed_by: "staff_darren",
    created_at: "2026-04-06T07:00:00Z",
  ...
  // Alex — week 2 (slight improvement)
  {
    ...
    evidence_refs: [
      { type: "daily_log", id: "log_mar_015", date: "2026-04-11", excerpt: "Alex helped Samuel wash the car — talked about his old dog. First sustained 1:1 conversation.", significance: "relational progress" },
    ],
    computed_by: "cara",
    reviewed_by: null,
    created_at: "2026-04-13T07:00:00Z",
